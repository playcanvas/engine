...
pc.gfx.VertexIterator = function VertexIterator(vertexBuffer) {
...
pc.gfx.VertexIterator.prototype.next = function () {
    var i = 0;
    ...
    while (i < numSetters) {
        ...
        if (setter.array.BYTES_PER_ELEMENT) {
...
pc.gfx.VertexIterator.prototype.end = function () {
