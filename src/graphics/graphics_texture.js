...
pc.extend(pc.gfx, function () {
    ...
    Texture2D = pc.inherits(Texture2D, Texture);

    pc.extend(Texture2D.prototype, {
        /**
         * @function
         ...
         */
        load: function (url, loader, batch) {
            var options = {
                batch: batch
            };
    ...
    TextureCube = pc.inherits(TextureCube, Texture);
    
    pc.extend(TextureCube.prototype, {
        /**
         * @function
         ...
         * @param {Number} [batch] A existing RequestBatch handle to append this request to.
         */
        load: function (urls, loader, requestBatch) {
            var options = {
                batch: requestBatch
            };
