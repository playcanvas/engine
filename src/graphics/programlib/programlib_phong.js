...
pc.gfx.programlib.phong.generateKey = function (options) {
    var key = "phong";
...
pc.gfx.programlib.phong.generateVertexShader = function (options) {
    var code = "";
...
pc.gfx.programlib.phong.generateFragmentShader = function (options) {
    var code = "";
