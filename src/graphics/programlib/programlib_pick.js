...
pc.gfx.programlib.pick.generateKey = function (options) {
    var key = "pick";
    if (options.skinning) key += "_skin";
    return key;
}

pc.gfx.programlib.pick.generateVertexShader = function (options) {
    var code = "";
...
pc.gfx.programlib.pick.generateFragmentShader = function (options) {
    var code = "";
