pc.extend(pc, function () {
     ...
     * @param {Boolean} options.minFilter The minification filter type to use. Defaults to pc.FILTER_LINEAR_MIPMAP_LINEAR
     * @param {Boolean} options.magFilter The magnification filter type to use. Defaults to pc.FILTER_LINEAR
     * @param {Boolean} options.anisotropy The level of anistropic filtering to use. Defaults to 1
     * @param {Boolean} options.addressU The repeat mode to use in the U direction. Defaults to pc.ADDRESS_REPEAT
     * @param {Boolean} options.addressV The repeat mode to use in the V direction. Defaults to pc.ADDRESS_REPEAT
