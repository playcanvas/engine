 ...
 * representations.
 *
 * {@link FloatPacking.float2Half} converts a JavaScript number to the 16-bit half-float encoding
 * used by half-precision textures and vertex formats, so float data can be uploaded to the GPU at
 * half the size.
 *
 * @example
