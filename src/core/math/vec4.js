 ...
 * forms such as {@link Vec4#add2} and {@link Vec4#mul2} write the result of `lhs op rhs` into
 * `this`, and it is safe for `this` to also be one of the operands. Use {@link Vec4#clone} for
 * an independent copy and {@link Vec4#copy} to overwrite one vector with another.
 *
 * The static constants {@link Vec4.ZERO}, {@link Vec4.HALF} and {@link Vec4.ONE} are frozen
 * shared instances: read them freely, but writing to one throws.
 *
 * @example
