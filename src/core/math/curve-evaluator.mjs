import { CURVE_CARDINAL, CURVE_CATMULL, CURVE_LINEAR, CURVE_SMOOTHSTEP, CURVE_SPLINE, CURVE_STEP } from './constants.mjs';
...
class CurveEvaluator {
     ...
     *
     * @param {import('./curve.mjs').Curve} curve - The curve to evaluate.
