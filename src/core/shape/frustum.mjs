...
class Frustum {
     ...
     *
     * @param {import('../math/mat4.mjs').Mat4} matrix - The matrix describing the shape of the
     * frustum.
     * @example
     ...
     *
     * @param {import('../math/vec3.mjs').Vec3} point - The point to test.
     ...
     *
     * @param {import('./bounding-sphere.mjs').BoundingSphere} sphere - The sphere to test.
