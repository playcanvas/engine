...
class BoundingBox {
     ...
     *
     * @param {import('./ray.mjs').Ray} ray - Ray to test against (direction must be normalized).
     ...
     * @param {import('../math/mat4.mjs').Mat4} m - Transformation matrix to apply to source AABB.
     ...
     *
     * @param {import('./bounding-sphere.mjs').BoundingSphere} sphere - Bounding Sphere to test.
