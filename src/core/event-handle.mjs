...
class EventHandle {
    /**
     * @type {import('./event-handler.mjs').EventHandler}
     * @private
     */
    handler;
    ...
    /**
     * @type {import('./event-handler.mjs').HandleEventCallback}
     * @ignore
     */
    callback;
    ...
    /**
     * @param {import('./event-handler.mjs').EventHandler} handler - source object of the event.
     * @param {string} name - Name of the event.
     * @param {import('./event-handler.mjs').HandleEventCallback} callback - Function that is called when event is fired.
