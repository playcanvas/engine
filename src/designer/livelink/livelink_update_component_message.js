pc.extend(pc.designer, function () {
    /**
     * @name pc.designer.LiveLinkUpdateComponentMessage
    ...
    var LiveLinkUpdateComponentMessage = function(id, component, attribute, value) {
        this.type = pc.designer.LiveLinkMessageType.UPDATE_COMPONENT
        this.content = {
            id: id,
            component: component,
            attribute: attribute,
    ...
    LiveLinkUpdateComponentMessage = LiveLinkUpdateComponentMessage.extendsFrom(pc.designer.LiveLinkMessage);
    pc.designer.LiveLinkMessage.register("UPDATE_COMPONENT");
