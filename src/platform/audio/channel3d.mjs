...
import { DISTANCE_EXPONENTIAL, DISTANCE_INVERSE, DISTANCE_LINEAR } from './constants.mjs';
import { hasAudioContext } from './capabilities.mjs';
...
class Channel3d extends Channel {
     ...
     *
     * @param {import('../sound/manager.mjs').SoundManager} manager - The SoundManager instance.
     * @param {import('../sound/sound.mjs').Sound} sound - The sound to playback.
