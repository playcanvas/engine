...
import { Channel } from '../audio/channel.mjs';
import { Channel3d } from '../audio/channel3d.mjs';
...
class SoundManager extends EventHandler {
     ...
     *
     * @param {import('./sound.mjs').Sound} sound - The Sound object to play.
     ...
     *
     * @param {import('./sound.mjs').Sound} sound - The Sound object to play.
     * @param {import('../../core/math/vec3.mjs').Vec3} position - The position of the sound in 3D space.
     * @param {object} options - Optional options object.
     * @param {number} [options.volume] - The volume to playback at, between 0 and 1.
     * @param {boolean} [options.loop] - Whether to loop the sound when it reaches the end.
