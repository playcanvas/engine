...
import { DISTANCE_EXPONENTIAL, DISTANCE_INVERSE, DISTANCE_LINEAR } from '../audio/constants.mjs';
import { hasAudioContext } from '../audio/capabilities.mjs';

import { SoundInstance } from './instance.mjs';
...
class SoundInstance3d extends SoundInstance {
     ...
     *
     * @param {import('./manager.mjs').SoundManager} manager - The sound manager.
     * @param {import('./sound.mjs').Sound} sound - The sound to play.
