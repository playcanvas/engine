...
class WebgpuBindGroup {
     ...
     *
     * @param {import('./webgpu-graphics-device.mjs').WebgpuGraphicsDevice} device - Graphics device.
     * @param {import('../bind-group.mjs').BindGroup} bindGroup - Bind group to create the
     * descriptor for.
    ...
    createDescriptor(device, bindGroup) {
        ...
        bindGroup.textures.forEach((tex, textureIndex) => {
            ...
            /** @type {import('./webgpu-texture.mjs').WebgpuTexture} */
