...
import { array } from "../../../core/array-utils.mjs";
import { TRACEID_RENDERPIPELINE_ALLOC, TRACEID_PIPELINELAYOUT_ALLOC } from "../../../core/constants.mjs";

import { WebgpuVertexBufferLayout } from "./webgpu-vertex-buffer-layout.mjs";
...
class WebgpuRenderPipeline {
    ...
    constructor(device) {
        /** @type {import('./webgpu-graphics-device.mjs').WebgpuGraphicsDevice} */
        this.device = device;
    ...
    /**
     * @param {import('../bind-group-format.mjs').BindGroupFormat[]} bindGroupFormats - An array
    ...
    create(primitiveTopology, shader, renderTarget, pipelineLayout, blendState, depthState, vertexBufferLayout,
        ...
        /** @type {import('./webgpu-shader.mjs').WebgpuShader} */
