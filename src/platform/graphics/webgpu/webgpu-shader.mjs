...
import { SHADERLANGUAGE_WGSL } from '../constants.mjs';

import { ShaderProcessor } from '../shader-processor.mjs';
...
class WebgpuShader {
    ...
    /**
     * @param {import('../shader.mjs').Shader} shader - The shader.
     */
    constructor(shader) {
     ...
     *
     * @param {import('../graphics-device.mjs').GraphicsDevice} device - The graphics device.
