...
import { TextureUtils } from '../texture-utils.mjs';
...
class WebgpuTexture {
    ...
    /**
     * @param {import('./webgpu-graphics-device.mjs').WebgpuGraphicsDevice} device - The graphics
     * device.
     * @param {import('../texture.mjs').Texture} texture - The texture.
     */
