...
class WebgpuVertexBufferLayout {
     ...
     *
     * @param {import('../vertex-format.mjs').VertexFormat} vertexFormat0 - The first vertex format.
     * @param {import('../vertex-format.mjs').VertexFormat} [vertexFormat1] - The second vertex format.
