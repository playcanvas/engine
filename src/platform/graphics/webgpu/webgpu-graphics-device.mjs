import { TRACEID_RENDER_QUEUE } from '../../../core/constants.mjs';
import { Debug, DebugHelper } from '../../../core/debug.mjs';

import {
    PIXELFORMAT_RGBA32F, PIXELFORMAT_RGBA8, PIXELFORMAT_BGRA8, DEVICETYPE_WEBGPU
} from '../constants.mjs';
import { GraphicsDevice } from '../graphics-device.mjs';
import { DebugGraphics } from '../debug-graphics.mjs';
import { RenderTarget } from '../render-target.mjs';
import { StencilParameters } from '../stencil-parameters.mjs';

import { WebgpuBindGroup } from './webgpu-bind-group.mjs';
import { WebgpuBindGroupFormat } from './webgpu-bind-group-format.mjs';
import { WebgpuIndexBuffer } from './webgpu-index-buffer.mjs';
import { WebgpuRenderPipeline } from './webgpu-render-pipeline.mjs';
import { WebgpuRenderTarget } from './webgpu-render-target.mjs';
import { WebgpuShader } from './webgpu-shader.mjs';
import { WebgpuTexture } from './webgpu-texture.mjs';
import { WebgpuUniformBuffer } from './webgpu-uniform-buffer.mjs';
import { WebgpuVertexBuffer } from './webgpu-vertex-buffer.mjs';
import { WebgpuClearRenderer } from './webgpu-clear-renderer.mjs';
import { WebgpuMipmapRenderer } from './webgpu-mipmap-renderer.mjs';
import { WebgpuDebug } from './webgpu-debug.mjs';
import { WebgpuDynamicBuffers } from './webgpu-dynamic-buffers.mjs';
import { WebgpuGpuProfiler } from './webgpu-gpu-profiler.mjs';
import { WebgpuResolver } from './webgpu-resolver.mjs';
...
class WebgpuGraphicsDevice extends GraphicsDevice {
     ...
     * @param {import('../bind-group.mjs').BindGroup} bindGroup - Bind group to attach
     */
     ...
     * Start a render pass.
     *
     * @param {import('../render-pass.mjs').RenderPass} renderPass - The render pass to start.
     * @ignore
     */
     ...
     * End a render pass.
     *
     * @param {import('../render-pass.mjs').RenderPass} renderPass - The render pass to end.
     * @ignore
     */
    endPass(renderPass) {
