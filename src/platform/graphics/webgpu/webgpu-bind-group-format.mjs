...
import { SAMPLETYPE_FLOAT, SAMPLETYPE_UNFILTERABLE_FLOAT, SAMPLETYPE_DEPTH } from '../constants.mjs';

import { WebgpuUtils } from './webgpu-utils.mjs';
...
class WebgpuBindGroupFormat {
    /**
     * @param {import('../bind-group-format.mjs').BindGroupFormat} bindGroupFormat - Bind group format.
     */
