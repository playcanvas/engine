...
import { StringIds } from '../../../core/string-ids.mjs';
...
class WebgpuRenderTarget {
    ...
    /**
     * @param {import('../render-target.mjs').RenderTarget} renderTarget - The render target owning
     * this implementation.
     */
     ...
     *
     * @param {import('../webgpu/webgpu-graphics-device.mjs').WebgpuGraphicsDevice} device - The
     * graphics device.
     */
    destroy(device) {
     ...
     * @param {import('../webgpu/webgpu-graphics-device.mjs').WebgpuGraphicsDevice} device - The
     * graphics device.
     * @param {import('../render-target.mjs').RenderTarget} renderTarget - The render target.
     */
