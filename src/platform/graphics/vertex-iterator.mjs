...
import { typedArrayTypes } from './constants.mjs';
...
class VertexIteratorAccessor {
     ...
     * @param {import('./scope-id.mjs').ScopeId} vertexElement.scopeId - The shader input variable
     * corresponding to the attribute.
     * @param {number} vertexElement.size - The size of the attribute in bytes.
     * @param {import('./vertex-format.mjs').VertexFormat} vertexFormat - A vertex format that
...
class VertexIterator {
     ...
     *
     * @param {import('./vertex-buffer.mjs').VertexBuffer} vertexBuffer - The vertex buffer to be
     * iterated.
     */
