...
import { TRACEID_BINDGROUP_ALLOC } from '../../core/constants.mjs';
import { UNIFORM_BUFFER_DEFAULT_SLOT_NAME } from './constants.mjs';
...
class BindGroup {
    ...
    /** @type {import('./uniform-buffer.mjs').UniformBuffer[]} */
    uniformBuffers;
     ...
     *
     * @param {import('./graphics-device.mjs').GraphicsDevice} graphicsDevice - The graphics device
     * used to manage this uniform buffer.
     * @param {import('./bind-group-format.mjs').BindGroupFormat} format - Format of the bind group.
     * @param {import('./uniform-buffer.mjs').UniformBuffer} [defaultUniformBuffer] - The default
     ...
     * @param {import('./uniform-buffer.mjs').UniformBuffer} uniformBuffer - The Uniform buffer to
     * assign to the slot.
     */
     ...
     * @param {import('./texture.mjs').Texture} texture - Texture to assign to the slot.
     */
