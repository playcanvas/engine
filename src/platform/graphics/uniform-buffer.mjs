...
import { DynamicBufferAllocation } from './dynamic-buffers.mjs';
...
class UniformBuffer {
     ...
     * @param {import('./uniform-buffer-format.mjs').UniformBufferFormat} format - Format of the
     * uniform buffer.
     ...
     *
     * @param {import('./uniform-buffer-format.mjs').UniformFormat} uniformFormat - The format of
     * the uniform.
     */
