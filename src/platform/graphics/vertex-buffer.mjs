...
import { TRACEID_VRAM_VB } from '../../core/constants.mjs';
import { BUFFER_STATIC } from './constants.mjs';
...
class VertexBuffer {
     ...
     * @param {import('./vertex-format.mjs').VertexFormat} format - The vertex format of this vertex
     * buffer.
     ...
     *
     * @returns {import('./vertex-format.mjs').VertexFormat} The data format of the specified vertex
     * buffer.
     */
    getFormat() {
        return this.format;
