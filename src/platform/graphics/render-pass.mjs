...
import { TRACEID_RENDER_PASS, TRACEID_RENDER_PASS_DETAIL } from '../../core/constants.mjs';
import { DebugGraphics } from '../graphics/debug-graphics.mjs';
...
class RenderPass {
    ...
    /** @type {import('../graphics/render-target.mjs').RenderTarget} */
    renderTarget;
     ...
     *
     * @param {import('../graphics/graphics-device.mjs').GraphicsDevice} graphicsDevice - The
     * graphics device.
    ...
    /**
     * @param {import('../graphics/render-target.mjs').RenderTarget} renderTarget - The render
