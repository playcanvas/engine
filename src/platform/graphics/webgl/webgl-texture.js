    ...
    initialize(device, texture) {
        ...
        switch (texture._format) {
            ...
            case PIXELFORMAT_DXT1_SRGB:
                ...
                this._glInternalFormat = device.extCompressedTextureSRGB_S3TC.COMPRESSED_SRGB_S3TC_DXT1_EXT;
                break;
            case PIXELFORMAT_DXT3_SRGB:
                this._glFormat = gl.SRGB_ALPHA;
                this._glInternalFormat = device.extCompressedTextureSRGB_S3TC.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
                break;
            case PIXELFORMAT_DXT5_SRGB:
                this._glFormat = gl.SRGB_ALPHA;
                this._glInternalFormat = device.extCompressedTextureSRGB_S3TC.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
                break;
