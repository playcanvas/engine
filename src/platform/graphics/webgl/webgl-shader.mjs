...
import { TRACEID_SHADER_COMPILE } from '../../../core/constants.mjs';
import { now } from '../../../core/time.mjs';

import { WebglShaderInput } from './webgl-shader-input.mjs';
import { SHADERTAG_MATERIAL, semanticToLocation } from '../constants.mjs';
import { DeviceCache } from '../device-cache.mjs';
...
class WebglShader {
     ...
     *
     * @param {import('../shader.mjs').Shader} shader - The shader to free.
     */
    destroy(shader) {
        if (this.glProgram) {
     ...
     *
     * @param {import('./webgl-graphics-device.mjs').WebglGraphicsDevice} device - The graphics device.
     * @param {import('../shader.mjs').Shader} shader - The shader to restore.
     */
     ...
     *
     * @param {import('./webgl-graphics-device.mjs').WebglGraphicsDevice} device - The graphics device.
     * @param {import('../shader.mjs').Shader} shader - The shader to compile.
     */
     ...
     *
     * @param {import('./webgl-graphics-device.mjs').WebglGraphicsDevice} device - The graphics device.
     * @param {import('../shader.mjs').Shader} shader - The shader to query.
