...
import { Tracing } from '../../core/tracing.mjs';
import { TRACEID_TEXTURES } from '../../core/constants.mjs';
...
import { BlendState } from './blend-state.mjs';
import { DepthState } from './depth-state.mjs';
import { ScopeSpace } from './scope-space.mjs';
import { VertexBuffer } from './vertex-buffer.mjs';
import { VertexFormat } from './vertex-format.mjs';
...
class GraphicsDevice extends EventHandler {
     ...
     *
     * @type {import('./render-target.mjs').RenderTarget|null}
     * @ignore
     */
    backBuffer = null;
     ...
     *
     * @type {import('./texture.mjs').Texture[]}
     * @ignore
     */
    textures = [];
     ...
     *
     * @type {Set<import('./render-target.mjs').RenderTarget>}
     * @ignore
     */
    targets = new Set();
     ...
     *
     * @type {import('./dynamic-buffers.mjs').DynamicBuffers}
     * @ignore
     */
    dynamicBuffers;
     ...
     * The GPU profiler.
     *
     * @type {import('./gpu-profiler.mjs').GpuProfiler}
     */
    gpuProfiler;
     ...
     *
     * @param {import('./render-target.mjs').RenderTarget|null} renderTarget - The render target to
     * activate.
     * @example
     ...
     *
     * @param {import('./index-buffer.mjs').IndexBuffer} indexBuffer - The index buffer to assign to
     * the device.
     */
     ...
     *
     * @param {import('./vertex-buffer.mjs').VertexBuffer} vertexBuffer - The vertex buffer to
     ...
     *
     * @returns {import('./render-target.mjs').RenderTarget} The current render target.
     * @example
     ...
     *
     * @param {import('./render-target.mjs').RenderTarget} target - The render target to be
     * initialized.
     * @ignore
     */
     ...
     *
     * @type {import('./constants.mjs').DEVICETYPE_WEBGL1 | import('./constants.mjs').DEVICETYPE_WEBGL2 | import('./constants.mjs').DEVICETYPE_WEBGPU}
     */
    get deviceType() {
