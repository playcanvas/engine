...
import { TRACEID_RENDER_TARGET_ALLOC } from '../../core/constants.mjs';
import { PIXELFORMAT_DEPTH, PIXELFORMAT_DEPTHSTENCIL } from './constants.mjs';
...
class RenderTarget {
    ...
    /**
     * @type {import('./graphics-device.mjs').GraphicsDevice}
     * @private
     */
    _device;
     ...
     * @param {import('./texture.mjs').Texture} [options.colorBuffer] - The texture that this render
     * target will treat as a rendering surface.
     * @param {import('./texture.mjs').Texture[]} [options.colorBuffers] - The textures that this
     ...
     * @param {import('./texture.mjs').Texture} [options.depthBuffer] - The texture that this render
     ...
     * @returns {import('./texture.mjs').Texture} - Color buffer at the specified index.
     */
