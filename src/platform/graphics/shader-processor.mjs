...
import { UniformFormat, UniformBufferFormat } from './uniform-buffer-format.mjs';
import { BindGroupFormat, BindBufferFormat, BindTextureFormat } from './bind-group-format.mjs';
...
class ShaderProcessor {
     ...
     * @param {import('./shader.mjs').Shader} shader - The shader definition.
     ...
     * @param {import('./shader-processor-options.mjs').ShaderProcessorOptions} processingOptions -
     * Uniform formats.
     * @param {import('./shader.mjs').Shader} shader - The shader definition.
