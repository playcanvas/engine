...
import { basic } from '../shader-lib/programs/basic.mjs';
...
class BasicMaterial extends Material {
     ...
     *
     * @type {import('../../platform/graphics/texture.mjs').Texture|null}
     */
    colorMap = null;
    ...
    /**
     * @param {import('../../platform/graphics/graphics-device.mjs').GraphicsDevice} device - The graphics device.
