...
import { ShaderPass } from '../shader-pass.mjs';
import { EnvLighting } from '../graphics/env-lighting.mjs';
import { getProgramLibrary } from '../shader-lib/get-program-library.mjs';
import { _matTex2D, standard } from '../shader-lib/programs/standard.mjs';
import { Material } from './material.mjs';
import { StandardMaterialOptionsBuilder } from './standard-material-options-builder.mjs';
import { standardMaterialCubemapParameters, standardMaterialTextureParameters } from './standard-material-parameters.mjs';
 ...
 * @param {import('./standard-material-options.mjs').StandardMaterialOptions} options - An object with shader generator settings (based on current
 ...
 * @returns {import('./standard-material-options.mjs').StandardMaterialOptions} Returned settings will be used by the shader.
 */
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} diffuseMap The main
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} diffuseDetailMap The
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} specularMap The specular
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} specularityFactorMap The
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} clearCoatMap Monochrome
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} clearCoatGlossMap Monochrome
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} clearCoatNormalMap The
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} iridescenceMap The
 ...
 * "g", "b" or "a".
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} iridescenceThicknessMap The
 ...
 * (metal).
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} metalnessMap Monochrome
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} glossMap Gloss map
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} refractionMap The map of
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} thicknessMap The
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} emissiveMap The emissive
 ...
 * sheen value.
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} sheenMap The sheen
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} sheenGlossMap The sheen
 ...
 * them.
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} opacityMap The opacity map
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} normalMap The main
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} normalDetailMap The detail
 ...
 * (full bump mapping), but can be set to e.g. 2 to give even more pronounced bump effect.
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} heightMap The height map
 ...
 * effect.
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} envAtlas The prefiltered
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} cubeMap The cubic
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} sphereMap The spherical
 ...
 * @property {import('../../core/shape/bounding-box.mjs').BoundingBox} cubeMapProjectionBox The
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} lightMap A custom lightmap
 ...
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} aoMap The main (primary) baked ambient
 ...
 * "b" or "a".
 * @property {import('../../platform/graphics/texture.mjs').Texture|null} aoDetailMap The
