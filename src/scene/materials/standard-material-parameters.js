const standardMaterialParameterTypes = {
    ...
    sheenGlossMapMapRotation: 'number',
    ...
    refractionMapMapRotation: 'number',
    ...
    thicknessMapMapRotation: 'number',
    ...
    iridescenceMapMapRotation: 'number',
    ...
    iridescenceThicknessMapMapRotation: 'number',
