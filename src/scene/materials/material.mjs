...
import { processShader } from '../shader-lib/utils.mjs';
import { getDefaultMaterial } from './default-material.mjs';
...
class Material {
     ...
     * set this.
     *
     * @type {import('../../platform/graphics/shader.mjs').Shader}
     * @private
     */
    _shader = null;
     ...
     *
     * @type {Map<string, import('../../platform/graphics/shader.mjs').Shader>}
     * @ignore
     */
    variants = new Map();
     ...
     *
     * @type {import('../../platform/graphics/stencil-parameters.mjs').StencilParameters|null}
     */
    stencilFront = null;
     ...
     *
     * @type {import('../../platform/graphics/shader.mjs').Shader|null}
     */
    set shader(shader) {
        this._shader = shader;
    }
     ...
     * @param {number|number[]|Float32Array|import('../../platform/graphics/texture.mjs').Texture} data -
     ...
     *
     * @param {import('../mesh-instance.mjs').MeshInstance} meshInstance - The mesh instance to
     * de-register.
     * @ignore
     */
