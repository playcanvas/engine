...
StandardMaterialOptionsBuilder.prototype._updateEnvOptions = function (options, stdMat, scene, prefilteredCubeMap128) {
    ...
    options.useCubeMapRotation = stdMat.cubeMap ? stdMat.cubeMap.isRenderTarget : (stdMat.useSkybox && scene && scene.skyboxRotation && (!scene.skyboxRotation.equals(Quat.IDENTITY) || (scene._skyboxIsRenderTarget)));
};
