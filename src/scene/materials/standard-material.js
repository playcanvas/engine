Object.assign(pc, function () {
     ...
     * @property {boolean} async If set to true, will ensure shader compilation will not freeze the thread at runtime. Shader will be compiled in async manner, so if shader is not compiled, meshes with this material will not be rendered.
     *
