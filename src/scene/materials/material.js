...
import {
    ...
    BLEND_MIN, BLEND_MAX, BLEND_CUSTOM
} from '../constants.js';
 ...
 * - {@link BLEND_CUSTOM}: Custom blend parameters not covered by predefined blend types.
 *
...
class Material {
    ...
    get transparent() {
        return this.blend || this.blendSrc !== BLENDMODE_ONE || this.blendDst !== BLENDMODE_ZERO || this.blendEquation !== BLENDEQUATION_ADD || this.separateAlphaBlend;
    }
    ...
    set blendType(type) {
        ...
        switch (type) {
            ...
            case BLEND_MAX:
                ...
                break;
            case BLEND_CUSTOM:
                Debug.warn('Use setCustomBlendType() to change blendType to BLEND_CUSTOM');
                return;
        }
    ...
    get blendType() {
        if (!this.transparent) {
            return BLEND_NONE;
        } else if(this.separateAlphaBlend) {
            return BLEND_CUSTON;
        } else if ((this.blend) &&
                   (this.blendSrc === BLENDMODE_SRC_ALPHA) &&
                   (this.blendDst === BLENDMODE_ONE_MINUS_SRC_ALPHA) &&
    ...
    /**
     * Set custom blend mode. Use this if you need more fine-grained control over the blending than
     * what the predefined blendType values provide.
     *
     * @param {number} blendSrc - The component the source fragment is multiplied by. Can be:
     *
     * - {@link BLENDMODE_ZERO}: multiply by 0.
     * - {@link BLENDMODE_ONE}: multiply by 1.
     * - {@link BLENDMODE_SRC_COLOR}: multiply by RGB of source fragment.
     * - {@link BLENDMODE_ONE_MINUS_SRC_COLOR}: multiply by (1 - RGB of source fragment).
     * - {@link BLENDMODE_DST_COLOR}: multiply by RGB of destination fragment.
     * - {@link BLENDMODE_ONE_MINUS_DST_COLOR}: multiply by (1 - RGB of destination fragment).
     * - {@link BLENDMODE_SRC_ALPHA}: multiply by Alpha of source fragment.
     * - {@link BLENDMODE_ONE_MINUS_SRC_ALPHA}: multiply by (1 - Alpha of source fragment).
     * - {@link BLENDMODE_DST_ALPHA}: multiply by Alpha of destination fragment.
     * - {@link BLENDMODE_ONE_MINUS_DST_ALPHA}: multiply by (1 - Alpha of destination fragment).
     *
     * @param {number} blendDst - The component the destination fragment is multiplied by. Can be:
     *
     * - {@link BLENDMODE_ZERO}: multiply by 0.
     * - {@link BLENDMODE_ONE}: multiply by 1.
     * - {@link BLENDMODE_SRC_COLOR}: multiply by RGB of source fragment.
     ...
     * - {@link BLENDMODE_ONE_MINUS_DST_ALPHA}: multiply by (1 - Alpha of destination fragment).
     *
     * @param {number} blendEquation - The operand used to combine the two products. Can be:
     *
     * - {@link BLENDEQUATION_ADD}: Add the results of the source and destination fragment products.
     * - {@link BLENDEQUATION_SUBTRACT}: Subtract the results of the source and destination fragment
     * products.
     * - {@link BLENDEQUATION_REVERSE_SUBTRACT}: Reverse and subtract the results of the source and
     * destination fragment products.
     * - {@link BLENDEQUATION_MIN}: Use the smaller fragment value.
     * - {@link BLENDEQUATION_MAX}: Use the larger fragment value.
     *
     * @param {boolean} separateAlphaBlend - If false, the alpha component of source and destination
     * fragments are treated the same way as the color components. If set to true, separate blend
     * parameters can be set for the alpha component.
     * @param {number} blendSrcAlpha - The component the source fragment's alpha is multiplied by.
     * only used if separateAlphaBlend is true. Can be:
     *
     * - {@link BLENDMODE_ZERO}: multiply by 0.
     * - {@link BLENDMODE_ONE}: multiply by 1.
     * - {@link BLENDMODE_SRC_COLOR}: multiply by RGB of source fragment.
     ...
     * - {@link BLENDMODE_ONE_MINUS_DST_ALPHA}: multiply by (1 - Alpha of destination fragment).
     *
     * @param {number} blendDstAlpha - The component the destination fragment aplha is multiplied
     * by. only used if separateAlphaBlend is true. Can be:
     *
     * - {@link BLENDMODE_ZERO}: multiply by 0.
     * - {@link BLENDMODE_ONE}: multiply by 1.
     * - {@link BLENDMODE_SRC_COLOR}: multiply by RGB of source fragment.
     ...
     * - {@link BLENDMODE_ONE_MINUS_DST_ALPHA}: multiply by (1 - Alpha of destination fragment).
     *
     * @param {number} blendAlphaEquation - The operand used to combine the two alpha products. only
     * used if separateAlphaBlend is true. Can be:
     *
     * - {@link BLENDEQUATION_ADD}: Add the results of the source and destination fragment products.
     * - {@link BLENDEQUATION_SUBTRACT}: Subtract the results of the source and destination fragment
     * products.
     ...
     *
     */
    setCustomBlendType(blendSrc, blendDst, blendEquation,
        ...
        this.separateAlphaBlend = separateAlphaBlend;
