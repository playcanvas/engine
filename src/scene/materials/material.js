Object.assign(pc, function () {
     ...
     * @property {boolean} async If set to true, renderer will not freeze rendering loop if shader is not compiled, and will skip draw call that uses shader of this material. Set to true to reduce freezes during runtime. (default is true).
