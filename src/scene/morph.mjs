...
import { FloatPacking } from '../core/math/float-packing.mjs';
...
class Morph extends RefCountedObject {
     ...
     *
     * @param {import('./morph-target.mjs').MorphTarget[]} targets - A list of morph targets.
     ...
     *
     * @type {import('./morph-target.mjs').MorphTarget[]}
     */
    get targets() {
