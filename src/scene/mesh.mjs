...
import { RefCountedObject } from '../core/ref-counted-object.mjs';
...
import { RENDERSTYLE_SOLID, RENDERSTYLE_WIREFRAME, RENDERSTYLE_POINTS } from './constants.mjs';
...
class Mesh extends RefCountedObject {
    ...
    constructor(graphicsDevice) {
         ...
         *
         * @type {import('./skin.mjs').Skin|null}
         */
        this.skin = null;
     ...
     *
     * @type {import('./morph.mjs').Morph|null}
     */
    set morph(morph) {
