pc.extend(pc, function () {
     ...
     * @property {pc.StencilParameters} stencilFront Stencil test parameters for front faces.
     * @property {pc.StencilParameters} stencilBack Stencil test parameters for back faces.
