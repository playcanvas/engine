...
import { hash32Fnv1a } from '../core/hash.mjs';
...
class CulledInstances {
     ...
     *
     * @type {import('./mesh-instance.mjs').MeshInstance[]}
     */
    opaque = [];
...
class Layer {
     ...
     *
     * @type {WeakMap<import('./camera.mjs').Camera, CulledInstances>}
     * @private
     */
     ...
     *
     * @type {Set<import('./light.mjs').Light>}
     * @private
     */
     ...
     *
     * @param {import('./mesh-instance.mjs').MeshInstance[]} meshInstances - Array of
     * {@link MeshInstance}.
     ...
     *
     * @param {import('../framework/components/light/component.mjs').LightComponent} light - A
     * {@link LightComponent}.
     */
    addLight(light) {
     ...
     *
     * @param {import('../framework/components/camera/component.mjs').CameraComponent} camera - A
    ...
    /**
     * @param {import('./mesh-instance.mjs').MeshInstance[]} drawCalls - Array of mesh instances.
     * @param {number} drawCallsCount - Number of mesh instances.
     * @param {import('../core/math/vec3.mjs').Vec3} camPos - Camera position.
     * @param {import('../core/math/vec3.mjs').Vec3} camFwd - Camera forward vector.
     * @private
     */
    ...
    /**
     * @param {import('./camera.mjs').Camera} camera - The camera to sort the visible mesh instances
     * for.
