Object.assign(pc, (function () {
    ...
    Object.assign(LayerComposition.prototype, {
        ...
        _isSublayerAdded: function (layer, transparent) {
         ...
         * @param {Number} index Insertion position.
         */
        insertOpaque: function (layer, index) {
         ...
         * @param {pc.Layer} layer A {@link pc.Layer} to add.
         */
        pushTransparent: function (layer) {
         ...
         * @param {Number} index Insertion position.
         */
        insertTransparent: function (layer, index) {
         ...
         * @param {pc.Layer} layer A {@link pc.Layer} to remove.
         */
        removeTransparent: function (layer) {
        ...
        _getSublayerIndex: function (layer, transparent) {
         ...
         */
        getTransparentIndex: function (layer) {
