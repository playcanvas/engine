...
import { drawQuadWithShader } from './quad-render-utils.mjs';
...
class PostEffect {
     ...
     *
     * @param {import('../../platform/graphics/render-target.mjs').RenderTarget} inputTarget - The
     * input render target.
     * @param {import('../../platform/graphics/render-target.mjs').RenderTarget} outputTarget - The
     * output render target. If null then this will be the screen.
     * @param {import('../../core/math/vec4.mjs').Vec4} [rect] - The rect of the current camera. If
     ...
     *
     * @param {import('../../platform/graphics/render-target.mjs').RenderTarget} target - The output
     * render target.
     * @param {import('../../platform/graphics/shader.mjs').Shader} shader - The shader to be used for
     * drawing the rectangle.
     * @param {import('../../core/math/vec4.mjs').Vec4} [rect] - The normalized screen-space position
