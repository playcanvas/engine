...
import { random } from '../../core/math/random.mjs';
...
import { ChunkUtils } from '../shader-lib/chunk-utils.mjs';
 ...
 * @param {import('../../core/math/vec4.mjs').Vec4} [options.rect] - Optional viewport rectangle.
