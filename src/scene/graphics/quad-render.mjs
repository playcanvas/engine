...
import { BINDGROUP_MESH, PRIMITIVE_TRISTRIP } from "../../platform/graphics/constants.mjs";
...
class QuadRender {
     ...
     *
     * @param {import('../../platform/graphics/shader.mjs').Shader} shader - The shader to be used to render the quad.
     */
    constructor(shader) {
     ...
     * after the rendering.
     *
     * @param {import('../../core/math/vec4.mjs').Vec4} [viewport] - The viewport rectangle of the
     * quad, in pixels. The viewport is not changed if not provided.
     * @param {import('../../core/math/vec4.mjs').Vec4} [scissor] - The scissor rectangle of the
