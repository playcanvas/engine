...
import { getDefaultMaterial } from './materials/default-material.mjs';
import { LightmapCache } from './graphics/lightmap-cache.mjs';
...
class InstancingData {
    /** @type {import('../platform/graphics/vertex-buffer.mjs').VertexBuffer|null} */
    vertexBuffer = null;
...
class ShaderInstance {
     ...
     * A shader.
     *
     * @type {import('../platform/graphics/shader.mjs').Shader|undefined}
     */
    shader;
 ...
 * @param {import('../core/math/vec3.mjs').Vec3} cameraPosition - The position of the camera.
 * @param {import('../core/math/vec3.mjs').Vec3} cameraForward - The forward vector of the camera.
 */
...
class MeshInstance {
    ...
    /**
     * @type {import('./materials/material.mjs').Material|null}
     * @private
     */
    _material = null;
     ...
     *
     * @param {import('./mesh.mjs').Mesh} mesh - The graphics mesh to instance.
     * @param {import('./materials/material.mjs').Material} material - The material to use for this
     * mesh instance.
    ...
    constructor(mesh, material, node = null) {
        ...
        /**
         * @type {import('./skin-instance.mjs').SkinInstance|null}
         * @private
         */
        this._skinInstance = null;

        /**
         * @type {import('./morph-instance.mjs').MorphInstance|null}
         * @private
         */
     ...
     * @param {import('./scene.mjs').Scene} scene - The scene.
     * @param {import('../platform/graphics/uniform-buffer-format.mjs').UniformBufferFormat} [viewUniformFormat] - The
     * format of the view uniform buffer.
     * @param {import('../platform/graphics/bind-group-format.mjs').BindGroupFormat} [viewBindGroupFormat] - The
     ...
     *
     * @type {import('./materials/material.mjs').Material}
     */
     ...
     *
     * @type {import('./skin-instance.mjs').SkinInstance}
     */
     ...
     *
     * @type {import('./morph-instance.mjs').MorphInstance}
     */
     ...
     *
     * @param {import('../platform/graphics/vertex-buffer.mjs').VertexBuffer|null} vertexBuffer - Vertex buffer to hold per-instance vertex data
     ...
     * @param {number|number[]|import('../platform/graphics/texture.mjs').Texture} data - The value
