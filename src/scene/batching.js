pc.extend(pc, function () {
    ...
    BatchManager.prototype = {
         ...
         */
        addGroup: function (name, dynamic, maxAabbSize, id, layers) {
            if (id === undefined) {
        ...
        _removeModelsFromBatchGroup: function (node, id) {
        ...
        _collectAndRemoveModels: function (node, groupMeshInstances, groupIds) {
            if (!node.enabled) return;
        ...
        _markGroupDirty: function (id) {
            if (this._dirtyGroups.indexOf(id) < 0) {
                this._dirtyGroups.push(id);
            }
        },

        _registerEntities: function (batch, meshInstances) {
            var node;
            var ents = [];
         ...
         */
        prepare: function (meshInstances, dynamic, maxAabbSize) {
         ...
         */
        create: function (meshInstances, dynamic, batchGroupId) {
         ...
         */
        clone: function (batch, clonedMeshInstances) {
         ...
         */
        register: function (batch, entities) {
