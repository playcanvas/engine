...
import { PIXELFORMAT_RGBA8, PIXELFORMAT_RGBA32F, ADDRESS_CLAMP_TO_EDGE, TEXTURETYPE_DEFAULT, FILTER_NEAREST } from '../../platform/graphics/constants.mjs';
import { FloatPacking } from '../../core/math/float-packing.mjs';
import { LIGHTSHAPE_PUNCTUAL, LIGHTTYPE_SPOT, MASK_AFFECT_LIGHTMAPPED, MASK_AFFECT_DYNAMIC } from '../constants.mjs';
import { Texture } from '../../platform/graphics/texture.mjs';
import { LightCamera } from '../renderer/light-camera.mjs';
