...
import { LIGHTTYPE_OMNI, LIGHTTYPE_SPOT, SHADOW_PCF3 } from '../constants.mjs';
import { CookieRenderer } from '../renderer/cookie-renderer.mjs';
import { ShadowMap } from '../renderer/shadow-map.mjs';
