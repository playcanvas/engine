...
import { SPRITE_RENDERMODE_SIMPLE } from '../constants.mjs';
import { Mesh } from '../mesh.mjs';
import { MeshInstance } from '../mesh-instance.mjs';
import { shaderChunks } from '../shader-lib/chunks/chunks.mjs';
import { Batch } from './batch.mjs';
import { BatchGroup } from './batch-group.mjs';
import { SkinBatchInstance } from './skin-batch-instance.mjs';
...
class BatchManager {
     ...
     * @param {import('../../framework/entity.mjs').Entity} root - The entity under which batched
     * models are added.
     * @param {import('../scene.mjs').Scene} scene - The scene that the batch manager affects.
     */
