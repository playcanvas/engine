import { TRACEID_RENDER_ACTION } from '../../core/constants.mjs';
import { Debug } from '../../core/debug.mjs';
import { Tracing } from '../../core/tracing.mjs';
import { EventHandler } from '../../core/event-handler.mjs';
import { sortPriority } from '../../core/sort.mjs';
import { LAYERID_DEPTH } from '../constants.mjs';
import { RenderAction } from './render-action.mjs';
...
class LayerComposition extends EventHandler {
     ...
     *
     * @type {Map<number, import('../layer.mjs').Layer>}
     * @ignore
     */
    layerIdMap = new Map();
     ...
     *
     * @type {Map<string, import('../layer.mjs').Layer>}
     * @ignore
     */
     ...
     *
     * @param {import('../layer.mjs').Layer} layer - A {@link Layer} to add.
     */
    push(layer) {
     ...
     *
     * @param {import('../layer.mjs').Layer} layer - A {@link Layer} to remove.
     */
    remove(layer) {
     ...
     *
     * @param {import('../layer.mjs').Layer} layer - A {@link Layer} to find index of.
     ...
     * @returns {import('../layer.mjs').Layer|null} The layer corresponding to the specified ID.
     ...
     * @returns {import('../layer.mjs').Layer|null} The layer corresponding to the specified name.
     * Returns null if layer is not found.
     */
    getLayerByName(name) {
