...
class Skeleton {
     ...
     *
     * @param {import('../graph-node.mjs').GraphNode} graph - The root {@link GraphNode} of the
     * skeleton.
     */
    constructor(graph) {
        /**
         * @type {import('./animation.mjs').Animation}
         * @private
         */
     ...
     *
     * @param {import('../graph-node.mjs').GraphNode} graph - The root node of the graph that the
