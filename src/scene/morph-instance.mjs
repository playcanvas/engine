...
import { BLENDEQUATION_ADD, BLENDMODE_ONE } from '../platform/graphics/constants.mjs';
...
class MorphInstance {
     ...
     *
     * @param {import('./morph.mjs').Morph} morph - The {@link Morph} to instance.
     */
    constructor(morph) {
        /**
         * The morph with its targets, which is being instanced.
         *
         * @type {import('./morph.mjs').Morph}
         */
        this.morph = morph;
        morph.incRefCount();
     ...
     * @returns {import('../platform/graphics/shader.mjs').Shader} Shader.
     * @private
     */
    _getShader(count) {
