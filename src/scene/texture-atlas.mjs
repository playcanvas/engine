...
class TextureAtlas extends EventHandler {
     ...
     * @param {import('../core/math/vec4.mjs').Vec4} data.rect - The u, v, width, height properties
     * of the frame in pixels.
     * @param {import('../core/math/vec2.mjs').Vec2} data.pivot - The pivot of the frame - values
     * are between 0-1.
     * @param {import('../core/math/vec4.mjs').Vec4} data.border - The border of the frame for
