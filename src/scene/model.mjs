import { RENDERSTYLE_WIREFRAME } from './constants.mjs';
import { MeshInstance } from './mesh-instance.mjs';
import { MorphInstance } from './morph-instance.mjs';
import { SkinInstance } from './skin-instance.mjs';
...
class Model {
     ...
     *
     * @type {import('./graph-node.mjs').GraphNode|null}
     */
    graph = null;
