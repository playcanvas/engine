pc.extend(pc, function () {
    ...
    Sprite.prototype = {
        ...
        _createSimpleMesh: function (frame) {
            var rect = frame.rect;
        ...
        _onFrameChanged: function (frameKey, frame) {
        ...
        _onFrameRemoved: function (frameKey) {
            var idx = this._frameKeys.indexOf(frameKey);
            if (idx < 0) return;
