...
import { WorldClustersDebug } from '../lighting/world-clusters-debug.mjs';
import { SceneGrab } from '../graphics/scene-grab.mjs';
...
class ForwardRenderer extends Renderer {
     ...
     *
     * @param {import('../frame-graph.mjs').FrameGraph} frameGraph - The frame-graph that is built.
     * @param {import('../composition/layer-composition.mjs').LayerComposition} layerComposition - The
    ...
    /**
     * @param {import('../frame-graph.mjs').FrameGraph} frameGraph - The frame graph.
     * @param {import('../composition/layer-composition.mjs').LayerComposition} layerComposition - The
     * layer composition.
     */
     ...
     * @param {import('../composition/layer-composition.mjs').LayerComposition} comp - The layer
     * composition.
     * @param {import('../composition/render-action.mjs').RenderAction} renderAction - The render
     * action.
