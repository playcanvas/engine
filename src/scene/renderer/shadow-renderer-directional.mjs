...
import { ShadowMap } from './shadow-map.mjs';
...
class ShadowRendererDirectional {
    ...
    /** @type {import('./shadow-renderer.mjs').ShadowRenderer} */
    shadowRenderer;
     ...
     * @param {import('../light.mjs').Light[]} directionalLights - The
     * directional lights.
     * @param {import('../../framework/components/camera/component.mjs').CameraComponent} camera - The camera.
     */
