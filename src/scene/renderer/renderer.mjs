...
import { Mat3 } from '../../core/math/mat3.mjs';
...
import { LightTextureAtlas } from '../lighting/light-texture-atlas.mjs';
import { Material } from '../materials/material.mjs';
import { LightCube } from '../graphics/light-cube.mjs';
...
import { UniformBuffer } from '../../platform/graphics/uniform-buffer.mjs';
import { BindGroup } from '../../platform/graphics/bind-group.mjs';
import { UniformFormat, UniformBufferFormat } from '../../platform/graphics/uniform-buffer-format.mjs';
import { BindGroupFormat, BindBufferFormat, BindTextureFormat } from '../../platform/graphics/bind-group-format.mjs';

import { ShadowMapCache } from './shadow-map-cache.mjs';
import { ShadowRendererLocal } from './shadow-renderer-local.mjs';
import { ShadowRendererDirectional } from './shadow-renderer-directional.mjs';
import { CookieRenderer } from './cookie-renderer.mjs';
import { ShadowRenderer } from './shadow-renderer.mjs';
import { WorldClustersAllocator } from './world-clusters-allocator.mjs';
...
class Renderer {
     ...
     *
     * @type {Set<import('../mesh-instance.mjs').MeshInstance>}
     * @private
     */
     ...
     *
     * @param {import('../../platform/graphics/graphics-device.mjs').GraphicsDevice} graphicsDevice - The
     * graphics device used by the renderer.
     */
    constructor(graphicsDevice) {
        this.device = graphicsDevice;

        /** @type {import('../scene.mjs').Scene|null} */
        this.scene = null;
     ...
     *
     * @param {import('../camera.mjs').Camera} camera - The camera containing the viewport
     * information.
     * @param {import('../../platform/graphics/render-target.mjs').RenderTarget} [renderTarget] - The
     ...
     *
     * @param {import('../camera.mjs').Camera} camera - The camera supplying the value to clear to.
     ...
     *
     * @param {import('../mesh-instance.mjs').MeshInstance[]|Set<import('../mesh-instance.mjs').MeshInstance>} drawCalls - MeshInstances
    ...
    /**
     * @param {import('../camera.mjs').Camera} camera - The camera used for culling.
     * @param {import('../mesh-instance.mjs').MeshInstance[]} drawCalls - Draw calls to cull.
     * @param {import('../layer.mjs').CulledInstances} culledInstances - Stores culled instances.
     */
     ...
     *
     * @param {import('../composition/layer-composition.mjs').LayerComposition} comp - The layer
     * composition.
     */
    cullShadowmaps(comp) {
    ...
    cullComposition(comp) {
        ...
        for (let i = 0; i < renderActions.length; i++) {
            ...
            /** @type {import('../composition/render-action.mjs').RenderAction} */
            const renderAction = renderActions[i];

            // layer
            const layerIndex = renderAction.layerIndex;
            /** @type {import('../layer.mjs').Layer} */
            ...
            /** @type {import('../../framework/components/camera/component.mjs').CameraComponent} */
    ...
    /**
     * @param {import('../mesh-instance.mjs').MeshInstance[]} drawCalls - Mesh instances.
