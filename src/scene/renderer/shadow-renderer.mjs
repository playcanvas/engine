...
import { SHADERSTAGE_FRAGMENT, SHADERSTAGE_VERTEX, UNIFORMTYPE_MAT4, UNIFORM_BUFFER_DEFAULT_SLOT_NAME } from '../../platform/graphics/constants.mjs';
import { DebugGraphics } from '../../platform/graphics/debug-graphics.mjs';
import { drawQuadWithShader } from '../graphics/quad-render-utils.mjs';
...
import { shaderChunks } from '../shader-lib/chunks/chunks.mjs';
import { createShaderFromCode } from '../shader-lib/utils.mjs';
import { LightCamera } from './light-camera.mjs';
import { UniformBufferFormat, UniformFormat } from '../../platform/graphics/uniform-buffer-format.mjs';
import { BindBufferFormat, BindGroupFormat } from '../../platform/graphics/bind-group-format.mjs';
...
class ShadowRenderer {
     ...
     *
     * @type {import('../shader-pass.mjs').ShaderPassInfo[][]}
     * @private
     */
    shadowPassCache = [];

    /**
     * @param {import('./renderer.mjs').Renderer} renderer - The renderer.
     * @param {import('../lighting/light-texture-atlas.mjs').LightTextureAtlas} lightTextureAtlas - The
     * shadow map atlas.
     */
    constructor(renderer, lightTextureAtlas) {
        this.device = renderer.device;

        /** @type {import('./renderer.mjs').Renderer} */
        this.renderer = renderer;

        /** @type {import('../lighting/light-texture-atlas.mjs').LightTextureAtlas} */
     ...
     * @param {import('../light.mjs').Light} light - The light.
     * @param {import('../mesh-instance.mjs').MeshInstance[]} visible - The array to store visible
     * mesh instances in.
     * @param {import('../camera.mjs').Camera} camera - The camera.
     * @param {import('../mesh-instance.mjs').MeshInstance[]} [casters] - Optional array of mesh
    ...
    /**
     * @param {import('../mesh-instance.mjs').MeshInstance[]} visibleCasters - Visible mesh
     * instances.
     * @param {import('../light.mjs').Light} light - The light.
     */
