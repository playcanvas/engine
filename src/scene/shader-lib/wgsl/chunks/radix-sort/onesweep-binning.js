...
// reliably on NVIDIA and Intel. Apple Silicon may stall or deadlock; for
// those devices the caller should fall back to the classic multi-pass path.
...
const MAX_SUBGROUPS: u32 = 8u; // sgSize=32 assumed
const WAVE_HISTS_SIZE: u32 = MAX_SUBGROUPS * RADIX; // 2048
...
fn main(
    ...
    // Each thread with TID < RADIX walks backward through passHist for its
    // digit until it finds FLAG_INCLUSIVE, accumulating reductions on the way.
