...
import { hashCode } from '../../core/hash.mjs';
import { version, revision } from '../../core/core.mjs';

import { Shader } from '../../platform/graphics/shader.mjs';

import { SHADER_FORWARD, SHADER_DEPTH, SHADER_PICK, SHADER_SHADOW } from '../constants.mjs';
import { ShaderPass } from '../shader-pass.mjs';
import { StandardMaterialOptions } from '../materials/standard-material-options.mjs';
...
class ProgramLibrary {
     ...
     *
     * @type {Map<string, import('./programs/shader-generator.mjs').ShaderGenerator>}
     */
    _generators = new Map();
     ...
     * shader definition.
     * @param {import('./programs/shader-generator.mjs').ShaderGenerator} generator - The generator
     * to use.
    ...
    dumpPrograms() {
        ...
        element.setAttribute('download', 'precompile-shaders.mjs');
