export default /* glsl */`
// Anisotropic GGX
float calcLightSpecular(float tGlossiness, vec3 tNormalW, vec3 viewDir, vec3 h, vec3 lightDirNorm) {
    ...
    float ToL = dot(dTBN[0], -lightDirNorm);
    float BoL = dot(dTBN[1], -lightDirNorm);
