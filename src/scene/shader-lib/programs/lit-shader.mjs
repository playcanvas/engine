...
import { LightsBuffer } from '../../lighting/lights-buffer.mjs';
import { ShaderPass } from '../../shader-pass.mjs';

import { validateUserChunks } from '../chunks/chunk-validation.mjs';
...
class LitShader {
    constructor(device, options) {
         ...
         * graphics device.
         * @param {import('./lit-shader-options.mjs').LitShaderOptions} options - The
         * lit options.
         * @ignore
         */
        this.device = device;
