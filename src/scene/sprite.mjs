...
import { SPRITE_RENDERMODE_SIMPLE, SPRITE_RENDERMODE_SLICED, SPRITE_RENDERMODE_TILED } from './constants.mjs';
import { createMesh } from './procedural.mjs';
...
class Sprite extends EventHandler {
     ...
     * @param {import('./texture-atlas.mjs').TextureAtlas} [options.atlas] - The texture atlas.
     * Defaults to null.
     ...
     * The texture atlas.
     *
     * @type {import('./texture-atlas.mjs').TextureAtlas}
     */
    set atlas(value) {
