...
import { PIXELFORMAT_RGBA8, ADDRESS_CLAMP_TO_EDGE, FILTER_LINEAR } from '../platform/graphics/constants.mjs';

import { BAKE_COLORDIR, FOG_NONE, GAMMA_SRGB, LAYERID_IMMEDIATE } from './constants.mjs';
import { Sky } from './sky.mjs';
import { LightingParams } from './lighting/lighting-params.mjs';
import { Immediate } from './immediate/immediate.mjs';
...
class Scene extends EventHandler {
     ...
     * root entity.
     *
     * @type {import('../framework/entity.mjs').Entity}
     */
    root = null;
     ...
     *
     * @param {import('../platform/graphics/graphics-device.mjs').GraphicsDevice} graphicsDevice -
    ...
    constructor(graphicsDevice) {
        ...
        /**
         * @type {import('./composition/layer-composition.mjs').LayerComposition}
         * @private
         */
        this._layers = null;
         ...
         *
         * @type {import('../platform/graphics/texture.mjs').Texture}
         * @private
         */
     ...
     * @param {import('../platform/graphics/texture.mjs').Texture} usedTex - Previously used cubemap
     ...
     * @param {import('./composition/layer-composition.mjs').LayerComposition} oldComp - Previously
     * used {@link LayerComposition}.
     * @param {import('./composition/layer-composition.mjs').LayerComposition} newComp - Newly set
     ...
     *
     * @param {import('../platform/graphics/texture.mjs').Texture[]} [cubemaps] - An array of
