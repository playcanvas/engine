 ...
 */
class FrameGraph {
    /** @type {import('../platform/graphics/render-pass.mjs').RenderPass[]} */
    renderPasses = [];

    /**
     * Map used during frame graph compilation. It maps a render target to its previous occurrence.
     *
     *  @type {Map<import('../platform/graphics/render-target.mjs').RenderTarget, import('../platform/graphics/render-pass.mjs').RenderPass>}
     */
     ...
     *
     * @param {import('../platform/graphics/render-pass.mjs').RenderPass} renderPass - The render
     * pass to add.
     */
