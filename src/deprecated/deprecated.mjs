import { revision, version } from '../core/core.mjs';
import { string } from '../core/string.mjs';
import { now } from '../core/time.mjs';
import { Debug } from '../core/debug.mjs';

import { math } from '../core/math/math.mjs';
import { Color } from '../core/math/color.mjs';
import { Mat4 } from '../core/math/mat4.mjs';
...
import { BoundingSphere } from '../core/shape/bounding-sphere.mjs';
import { Frustum } from '../core/shape/frustum.mjs';
import { Plane } from '../core/shape/plane.mjs';
...
} from '../platform/graphics/constants.mjs';
import { ShaderGenerator } from '../scene/shader-lib/programs/shader-generator.mjs';
import { drawQuadWithShader } from '../scene/graphics/quad-render-utils.mjs';
import { shaderChunks } from '../scene/shader-lib/chunks/chunks.mjs';
import { GraphicsDevice } from '../platform/graphics/graphics-device.mjs';
import { IndexBuffer } from '../platform/graphics/index-buffer.mjs';
import { LayerComposition } from '../scene/composition/layer-composition.mjs';
import { PostEffect } from '../scene/graphics/post-effect.mjs';
import { PostEffectQueue } from '../framework/components/camera/post-effect-queue.mjs';
import { ProgramLibrary } from '../scene/shader-lib/program-library.mjs';
import { getProgramLibrary, setProgramLibrary } from '../scene/shader-lib/get-program-library.mjs';
import { RenderTarget } from '../platform/graphics/render-target.mjs';
import { ScopeId } from '../platform/graphics/scope-id.mjs';
import { Shader } from '../platform/graphics/shader.mjs';
import { WebglShaderInput } from '../platform/graphics/webgl/webgl-shader-input.mjs';
import { Texture } from '../platform/graphics/texture.mjs';
import { VertexBuffer } from '../platform/graphics/vertex-buffer.mjs';
import { VertexFormat } from '../platform/graphics/vertex-format.mjs';
import { VertexIterator } from '../platform/graphics/vertex-iterator.mjs';
import { ShaderUtils } from '../platform/graphics/shader-utils.mjs';
...
import { DepthState } from '../platform/graphics/depth-state.mjs';

import { PROJECTION_ORTHOGRAPHIC, PROJECTION_PERSPECTIVE, LAYERID_IMMEDIATE, LINEBATCH_OVERLAY, LAYERID_WORLD } from '../scene/constants.mjs';
import { calculateTangents, createBox, createCapsule, createCone, createCylinder, createMesh, createPlane, createSphere, createTorus } from '../scene/procedural.mjs';
import { partitionSkin } from '../scene/skin-partition.mjs';
import { BasicMaterial } from '../scene/materials/basic-material.mjs';
import { ForwardRenderer } from '../scene/renderer/forward-renderer.mjs';
import { GraphNode } from '../scene/graph-node.mjs';
import { Material } from '../scene/materials/material.mjs';
import { Mesh } from '../scene/mesh.mjs';
import { Morph } from '../scene/morph.mjs';
import { MeshInstance } from '../scene/mesh-instance.mjs';
import { Model } from '../scene/model.mjs';
import { ParticleEmitter } from '../scene/particle-system/particle-emitter.mjs';
import { Picker } from '../framework/graphics/picker.mjs';
import { Scene } from '../scene/scene.mjs';
import { Skin } from '../scene/skin.mjs';
import { SkinInstance } from '../scene/skin-instance.mjs';
import { StandardMaterial } from '../scene/materials/standard-material.mjs';
import { Batch } from '../scene/batching/batch.mjs';
import { getDefaultMaterial } from '../scene/materials/default-material.mjs';
import { StandardMaterialOptions } from '../scene/materials/standard-material-options.mjs';
import { LitShaderOptions } from '../scene/shader-lib/programs/lit-shader-options.mjs';
import { Layer } from '../scene/layer.mjs';

import { Animation, Key, Node } from '../scene/animation/animation.mjs';
import { Skeleton } from '../scene/animation/skeleton.mjs';

import { Channel } from '../platform/audio/channel.mjs';
import { Channel3d } from '../platform/audio/channel3d.mjs';
import { Listener } from '../platform/sound/listener.mjs';
import { Sound } from '../platform/sound/sound.mjs';
import { SoundManager } from '../platform/sound/manager.mjs';

import { AssetRegistry } from '../framework/asset/asset-registry.mjs';

import { XrInputSource } from '../framework/xr/xr-input-source.mjs';

import { Controller } from '../platform/input/controller.mjs';
import { ElementInput } from '../framework/input/element-input.mjs';
import { GamePads } from '../platform/input/game-pads.mjs';
import { Keyboard } from '../platform/input/keyboard.mjs';
import { KeyboardEvent } from '../platform/input/keyboard-event.mjs';
import { Mouse } from '../platform/input/mouse.mjs';
import { MouseEvent } from '../platform/input/mouse-event.mjs';
import { TouchDevice } from '../platform/input/touch-device.mjs';
import { getTouchTargetCoords, Touch, TouchEvent } from '../platform/input/touch-event.mjs';

import { AppBase } from '../framework/app-base.mjs';
import { getApplication } from '../framework/globals.mjs';
import { CameraComponent } from '../framework/components/camera/component.mjs';
import { LightComponent } from '../framework/components/light/component.mjs';
import { ModelComponent } from '../framework/components/model/component.mjs';
import { RenderComponent } from '../framework/components/render/component.mjs';
import {
...
} from '../framework/components/rigid-body/constants.mjs';
import { RigidBodyComponent } from '../framework/components/rigid-body/component.mjs';
import { RigidBodyComponentSystem } from '../framework/components/rigid-body/system.mjs';
import { basisInitialize } from '../framework/handlers/basis.mjs';
import { LitShader } from '../scene/shader-lib/programs/lit-shader.mjs';
