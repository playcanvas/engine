...
pc.script = (function () {
    ...
    var script = {        
        ...
        * @example
        * pc.script.create( function (context) {
        *  pc.script.attribute('speed', 5);
        *  pc.script.attribute('message', "My message");
        *  pc.script.attribute('enemyPosition', [1,0,0], "vector");
        *  pc.script.attribute('spellType', 0, "enumeration", {
        *     enumerations: [{
        *        name: "Fire",
        *        value: 0
        *     }, {
        ...
        * }
        */
        attribute: function (name, defaultValue, type, options) {
