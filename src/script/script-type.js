...
function ScriptType(args) {
    // Ideally, ScriptType should subclass EventHandler and do this:
    //     EventHandler.call(this);
    // However, since EventHandler is written as an ES6 class, this is invalid and throws an
    // exception. The workaround is to inline the EventHandler constructor code here.
    this._callbacks = { };
