...
import { ApplicationLite } from '../framework/application-lite.js';
 ...
 * @param {ApplicationLite} [app] - Optional application handler, to choose which {@link ScriptRegistry}
 * to add a script to. By default it will use `Application.getApplication()` to get current
 * {@link ApplicationLite}.
...
function registerScript(script, name, app) {
    ...
    const registry = app ? app.scripts : ApplicationLite.getApplication().scripts;
    registry.add(script);
