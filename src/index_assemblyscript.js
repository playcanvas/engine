...
export { Mat3 } from './math_assemblyscript/mat3.js';
export { Mat4 } from './math_assemblyscript/mat4.js';
export { Quat } from './math_assemblyscript/quat.js';
export { Vec2 } from './math_assemblyscript/vec2.js';
export { Vec3 } from './math_assemblyscript/vec3.js';
export { Vec4 } from './math_assemblyscript/vec4.js';
