pc.extend(pc, (function () {
     ...
     *     of the coroutine, when you do this coroutine.pop() can be called to return the previous
     ...
     * @remarks This is a useful version of setInterval that works based on game time rather than
     *     system clock and hence can be slowed down with timeScale
     * @param {Function} fn Function to execute
