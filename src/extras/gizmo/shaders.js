...
/**
 * @param {boolean} depthTest - Whether to enable depth testing.
 * @returns {ShaderDesc} The unlit shader.
 */
export const unlitShader = (depthTest = true) => {
    return {
        uniqueName: `gizmo-unlit-${depthTest ? 'depth' : 'nodepth'}`,
        attributes: {
