import { AnimSnapshot } from './anim-snapshot.mjs';
...
class AnimClip {
     ...
     *
     * @param {import('./anim-track.mjs').AnimTrack} track - The animation data.
     ...
     * @param {import('../../../core/event-handler.mjs').EventHandler} [eventHandler] - The handler
