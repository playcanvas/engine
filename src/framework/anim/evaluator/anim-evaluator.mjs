import { AnimTargetValue } from './anim-target-value.mjs';
import { AnimBlend } from './anim-blend.mjs';
...
class AnimEvaluator {
     ...
     *
     * @param {import('../binder/anim-binder.mjs').AnimBinder} binder - interface resolves curve
     ...
     *
     * @type {import('./anim-clip.mjs').AnimClip[]}
     */
    get clips() {
        return this._clips;
    }
     ...
     *
     * @param {import('./anim-clip.mjs').AnimClip} clip - The clip to add to the evaluator.
     */
    addClip(clip) {
     ...
     * @returns {import('./anim-clip.mjs').AnimClip|null} - The clip with the given name or null if no such clip was found.
     */
    findClip(name) {
        const clips = this._clips;
