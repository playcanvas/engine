import { AnimEvents } from './anim-events.mjs';
...
class AnimTrack {
     ...
     * @param {import('./anim-data.mjs').AnimData[]} inputs - List of curve key data.
     * @param {import('./anim-data.mjs').AnimData[]} outputs - List of curve value data.
     * @param {import('./anim-curve.mjs').AnimCurve[]} curves - The list of curves.
     ...
     *
     * @type {import('./anim-data.mjs').AnimData[]}
     */
    get inputs() {
        return this._inputs;
    }
     ...
     *
     * @type {import('./anim-curve.mjs').AnimCurve[]}
     */
    get curves() {
        return this._curves;
    }
