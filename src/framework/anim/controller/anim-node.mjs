...
class AnimNode {
     ...
     *
     * @param {import('./anim-state.mjs').AnimState} state - The AnimState that this BlendTree
     * belongs to.
     * @param {import('./anim-blend-tree.mjs').AnimBlendTree|null} parent - The parent of the AnimNode.
