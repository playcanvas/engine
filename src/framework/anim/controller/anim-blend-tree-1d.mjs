...
import { AnimBlendTree } from './anim-blend-tree.mjs';
...
class AnimBlendTree1D extends AnimBlendTree {
     ...
     *
     * @param {import('./anim-state.mjs').AnimState} state - The AnimState that this AnimBlendTree
     * belongs to.
     ...
     * to its children.
     * @param {number|import('../../../core/math/vec2.mjs').Vec2} point - The coordinate/vector
