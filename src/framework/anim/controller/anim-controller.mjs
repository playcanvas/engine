...
import { AnimClip } from '../evaluator/anim-clip.mjs';
import { AnimState } from './anim-state.mjs';
import { AnimNode } from './anim-node.mjs';
import { AnimTransition } from './anim-transition.mjs';
import {
...
class AnimController {
     ...
     *
     * @param {import('../evaluator/anim-evaluator.mjs').AnimEvaluator} animEvaluator - The
     ...
     * @param {import('../../../core/event-handler.mjs').EventHandler} eventHandler - The event
