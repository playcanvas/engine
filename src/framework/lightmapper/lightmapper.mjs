...
import { LightingParams } from '../../scene/lighting/lighting-params.mjs';
import { WorldClusters } from '../../scene/lighting/world-clusters.mjs';
import { shaderChunks } from '../../scene/shader-lib/chunks/chunks.mjs';
import { shaderChunksLightmapper } from '../../scene/shader-lib/chunks/chunks-lightmapper.mjs';
...
import { BakeLightSimple } from './bake-light-simple.mjs';
import { BakeLightAmbient } from './bake-light-ambient.mjs';
import { BakeMeshNode } from './bake-mesh-node.mjs';
import { LightmapCache } from '../../scene/graphics/lightmap-cache.mjs';
import { LightmapFilters } from './lightmap-filters.mjs';
...
class Lightmapper {
     ...
     * @param {import('../entity.mjs').Entity} root - The root entity of the scene.
     * @param {import('../../scene/scene.mjs').Scene} scene - The scene to lightmap.
     * @param {import('../../scene/renderer/forward-renderer.mjs').ForwardRenderer} renderer - The
     * renderer.
     * @param {import('../asset/asset-registry.mjs').AssetRegistry} assets - Registry of assets to
     * lightmap.
     * @hideconstructor
     */
     ...
     *
     * @param {import('../entity.mjs').Entity[]|null} nodes - An array of entities (with model or
