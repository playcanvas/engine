pc.extend(pc, function () {
    ...
    return {
         ...
         * @param {pc.Application} app The Application containing the root hierarchy and the ScriptComponentSystem
         ...
         */
        // loadPack: function (guid, app, success, error, progress) {
        //     var request = new pc.resources.PackRequest(guid);
        //     app.loader.request(request, function (resources) {
        //         var pack = resources[guid];

        //         // add to hierarchy
        //         app.root.addChild(pack.hierarchy);
