...
import { Ray } from '../../core/shape/ray.mjs';
...
class ElementInputEvent {
     ...
     * raised.
     * @param {import('../components/element/component.mjs').ElementComponent} element - The
     * ElementComponent that this event was originally raised on.
     * @param {import('../components/camera/component.mjs').CameraComponent} camera - The
    ...
    constructor(event, element, camera) {
         ...
         *
         * @type {import('../components/element/component.mjs').ElementComponent}
         */
...
class ElementSelectEvent extends ElementInputEvent {
     ...
     * @param {import('../components/camera/component.mjs').CameraComponent} camera - The
     * CameraComponent that this event was originally raised via.
     * @param {import('../xr/xr-input-source.mjs').XrInputSource} inputSource - The XR input source
    ...
    constructor(event, element, camera, inputSource) {
         ...
         *
         * @type {import('../xr/xr-input-source.mjs').XrInputSource}
         */
