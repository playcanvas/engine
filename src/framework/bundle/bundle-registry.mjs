...
class BundleRegistry {
     ...
     *
     * @param {import('../asset/asset.mjs').Asset} asset - The asset.
     * @returns {import('../asset/asset.mjs').Asset[]} An array of bundle assets or null if the
     ...
     *
     * @returns {import('../asset/asset.mjs').Asset[]} An array of bundle assets.
     */
    list() {
        const result = [];
