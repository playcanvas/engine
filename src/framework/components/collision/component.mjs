 ...
 * @property {import('../../../scene/model.mjs').Model} model The model that is added to the scene
...
class CollisionComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').CollisionComponentSystem} system - The ComponentSystem that
     ...
     * @param {import('../../entity.mjs').Entity} other - The {@link Entity} that stopped touching this collision volume.
     */
     ...
     * @param {import('../../entity.mjs').Entity} other - The {@link Entity} that entered this collision volume.
     */
     ...
     * @param {import('../../entity.mjs').Entity} other - The {@link Entity} that exited this collision volume.
     */
    ...
    /**
     * @param {import('../../../scene/graph-node.mjs').GraphNode} parent - The parent node.
     * @private
     */
    _onInsert(parent) {
        // TODO
