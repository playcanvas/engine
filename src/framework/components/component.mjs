...
class Component extends EventHandler {
     ...
     *
     * @type {import('./system.mjs').ComponentSystem}
     */
    system;
     ...
     *
     * @param {import('./system.mjs').ComponentSystem} system - The ComponentSystem used to create
     * this Component.
     * @param {import('../entity.mjs').Entity} entity - The Entity that this Component is attached
     * to.
     */
