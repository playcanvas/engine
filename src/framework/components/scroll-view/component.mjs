...
import { ORIENTATION_HORIZONTAL, ORIENTATION_VERTICAL } from '../../../scene/constants.mjs';

import { EntityReference } from '../../utils/entity-reference.mjs';

import { ElementDragHelper } from '../element/element-drag-helper.mjs';

import { SCROLL_MODE_BOUNCE, SCROLL_MODE_CLAMP, SCROLL_MODE_INFINITE, SCROLLBAR_VISIBILITY_SHOW_ALWAYS, SCROLLBAR_VISIBILITY_SHOW_WHEN_REQUIRED } from './constants.mjs';
import { Component } from '../component.mjs';
import { EVENT_MOUSEWHEEL } from '../../../platform/input/constants.mjs';
 ...
 * @property {import('../../entity.mjs').Entity} viewportEntity The entity to be used as the masked
 * viewport area, within which the content will scroll. This entity must have an ElementGroup
 * component.
 * @property {import('../../entity.mjs').Entity} contentEntity The entity which contains the
 * scrolling content itself. This entity must have an Element component.
 * @property {import('../../entity.mjs').Entity} horizontalScrollbarEntity The entity to be used as
 * the vertical scrollbar. This entity must have a Scrollbar component.
 * @property {import('../../entity.mjs').Entity} verticalScrollbarEntity The entity to be used as
 * the vertical scrollbar. This entity must have a Scrollbar component.
 * @augments Component
...
class ScrollViewComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').ScrollViewComponentSystem} system - The ComponentSystem that
