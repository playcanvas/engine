...
import { EntityReference } from '../../utils/entity-reference.mjs';

import { Component } from '../component.mjs';

import { BUTTON_TRANSITION_MODE_SPRITE_CHANGE, BUTTON_TRANSITION_MODE_TINT } from './constants.mjs';
import { ELEMENTTYPE_GROUP } from '../element/constants.mjs';
 ...
 * @property {import('../../entity.mjs').Entity} imageEntity A reference to the entity to be used as
 * the button background. The entity must have an ImageElement component.
 * @property {import('../../../core/math/vec4.mjs').Vec4} hitPadding Padding to be used in hit-test
 ...
 * @property {import('../../asset/asset.mjs').Asset} hoverSpriteAsset Sprite to be used as the
 * button image when the user hovers over it.
 * @property {number} hoverSpriteFrame Frame to be used from the hover sprite.
 * @property {import('../../asset/asset.mjs').Asset} pressedSpriteAsset Sprite to be used as the
 * button image when the user presses it.
 * @property {number} pressedSpriteFrame Frame to be used from the pressed sprite.
 * @property {import('../../asset/asset.mjs').Asset} inactiveSpriteAsset Sprite to be used as the
...
class ButtonComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').ButtonComponentSystem} system - The ComponentSystem that
 ...
 * @param {import('../../input/element-input.mjs').ElementSelectEvent} event - The event.
 */
