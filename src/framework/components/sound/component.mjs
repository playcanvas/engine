...
import { DISTANCE_LINEAR } from '../../../platform/audio/constants.mjs';

import { Component } from '../component.mjs';

import { SoundSlot } from './slot.mjs';
...
class SoundComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').SoundComponentSystem} system - The ComponentSystem that
     * created this component.
     * @param {import('../../entity.mjs').Entity} entity - The entity that the Component is attached
     * to.
     */
     ...
     * @param {import('../../../platform/sound/instance.mjs').SoundInstance} instance - The instance
     ...
     * @returns {import('../../../platform/sound/instance.mjs').SoundInstance|null} The sound
