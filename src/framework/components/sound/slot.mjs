...
import { SoundInstance } from '../../../platform/sound/instance.mjs';
import { SoundInstance3d } from '../../../platform/sound/instance3d.mjs';
...
class SoundSlot extends EventHandler {
     ...
     *
     * @param {import('./component.mjs').SoundComponent} component - The Component that created this
     * slot.
     ...
     * @param {import('../../../platform/sound/sound.mjs').Sound} sound - The sound resource that
     * was loaded.
     */
