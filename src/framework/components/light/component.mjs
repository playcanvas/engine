 ...
 * @property {import('../../../core/math/vec2.mjs').Vec2} cookieScale Spotlight cookie scale.
 * @property {import('../../../core/math/vec2.mjs').Vec2} cookieOffset Spotlight cookie position
 * offset.
...
class LightComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').LightComponentSystem} system - The ComponentSystem that
