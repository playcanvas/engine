...
import { SPRITETYPE_SIMPLE, SPRITETYPE_ANIMATED } from './constants.mjs';
import { SpriteAnimationClip } from './sprite-animation-clip.mjs';
...
class SpriteComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').SpriteComponentSystem} system - The ComponentSystem that
     ...
     *
     * @type {number|import('../../asset/asset.mjs').Asset}
     */
     ...
     * The current sprite.
     *
     * @type {import('../../../scene/sprite.mjs').Sprite}
     */
    set sprite(value) {
     ...
     * @param {number|import('../../asset/asset.mjs').Asset} [data.spriteAsset] - The asset id or
