Object.assign(
  ...
  (function() {
    ...
    Object.assign(SpriteComponent.prototype, {
      ...
      _showModel: function() {
        ...
        for (i = 0, len = this._layers.length; i < len; i++) {
          var layer = this.system.app.scene.layers.getLayerById(
            this._layers[i]
          );
          if (layer) {
      ...
      _showFrame: function(frame) {
        ...
        if (
          ...
          var frameData = this.sprite.atlas.frames[
            this.sprite.frameKeys[frame]
          ];
          if (frameData) {
      ...
      _updateTransform: function() {
        ...
        if (
          ...
          scaleX *= pc.math.clamp(
            this._width / (this._innerOffset.x * scaleMulX),
            0.0001,
            1
          );
          scaleY *= pc.math.clamp(
            this._height / (this._innerOffset.y * scaleMulY),
            0.0001,
            1
          );
      ...
      play: function(name) {
        ...
        if (this._currentClip) {
          ...
          logWARNING(
            "Trying to play sprite animation " + name + " which does not exist."
          );
        }
    ...
    Object.defineProperty(SpriteComponent.prototype, "batchGroupId", {
      ...
      set: function(value) {
        ...
        if (this.entity.enabled && prev >= 0) {
          this.system.app.batcher.remove(
            pc.BatchGroup.SPRITE,
            prev,
            this.entity
          );
        ...
        if (this.entity.enabled && value >= 0) {
          this.system.app.batcher.insert(
            pc.BatchGroup.SPRITE,
            value,
            this.entity
          );
    ...
    Object.defineProperty(SpriteComponent.prototype, "autoPlayClip", {
      ...
      set: function(value) {
        this._autoPlayClip =
          value instanceof pc.SpriteAnimationClip ? value.name : value;
        this._tryAutoPlay();
      }
    });
