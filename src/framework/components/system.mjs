...
class ComponentSystem extends EventHandler {
     ...
     *
     * @param {import('../app-base.mjs').AppBase} app - The application managing this system.
     */
    constructor(app) {
        super();
     ...
     *
     * @param {import('../entity.mjs').Entity} entity - The Entity to attach this component to.
     * @param {object} [data] - The source data with which to create the component.
     * @returns {import('./component.mjs').Component} Returns a Component of type defined by the
     * component system.
     * @example
     ...
     *
     * @param {import('../entity.mjs').Entity} entity - The entity to remove the component from.
     * @example
     ...
     *
     * @param {import('../entity.mjs').Entity} entity - The entity to clone the component from.
     * @param {import('../entity.mjs').Entity} clone - The entity to clone the component into.
     * @returns {import('./component.mjs').Component} The newly cloned component.
     * @ignore
     */
     ...
     *
     * @param {import('./component.mjs').Component} component - The component being initialized.
