 ...
 * @property {boolean} enableMarkup Flag for enabling markup processing. Only works for {@link pc.ELEMENTTYPE_TEXT} types. Supported tags are `[color]` with a hex color value. E.g `[color="#ff0000"]red text[/color]`
