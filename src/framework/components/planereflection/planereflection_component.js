pc.extend(pc.fw, function () {
    var PlaneReflectionComponent = function (context) {
            context.components.add("planereflection", this);
        };

    PlaneReflectionComponent = PlaneReflectionComponent.extendsFrom(pc.fw.Component);
    
    PlaneReflectionComponent.prototype.createComponent = function (entity, data) {
        var componentData = new pc.fw.PlaneReflectionComponentData();
        ...
        componentData.camera = this.context.manager.create(pc.graph.Camera);
    ...
    PlaneReflectionComponent.prototype.deleteComponent = function (entity) {
        var data = this._getComponentData(entity);

        this.removeComponent(entity);
    };
    
    PlaneReflectionComponent.prototype.update = function (dt) {};

    PlaneReflectionComponent.prototype.render = function () {
        var id;
        var entity;
        var componentData;
        ...
        for (id in components) {
            if (components.hasOwnProperty(id)) {
                ...
                for (var face = 0; face < 6; face++) {
                    ...
                    pc.fw.Component.render(this.context, false);
    ...
    return {
        PlaneReflectionComponent: PlaneReflectionComponent
    }; 
}());
