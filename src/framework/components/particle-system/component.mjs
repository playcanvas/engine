import { LAYERID_DEPTH } from '../../../scene/constants.mjs';
 ...
 * @property {import('../../../core/math/vec3.mjs').Vec3} emitterExtents (Only for EMITTERSHAPE_BOX)
 * The extents of a local space bounding box within which particles are spawned at random positions.
 * @property {import('../../../core/math/vec3.mjs').Vec3} emitterExtentsInner (Only for
 ...
 * @property {import('../../../core/math/vec3.mjs').Vec3} wrapBounds The half extents of a world
 ...
 *
 * @property {import('../../../core/math/vec3.mjs').Vec3} particleNormal (Only for
 ...
 * EmitterExtents.
 * @property {import('../../../core/math/curve-set.mjs').CurveSet} localVelocityGraph Velocity
 * relative to emitter over lifetime.
 * @property {import('../../../core/math/curve-set.mjs').CurveSet} localVelocityGraph2 If not null,
 * particles pick random values between localVelocityGraph and localVelocityGraph2.
 * @property {import('../../../core/math/curve-set.mjs').CurveSet} velocityGraph World-space
 * velocity over lifetime.
 * @property {import('../../../core/math/curve-set.mjs').CurveSet} velocityGraph2 If not null,
 * particles pick random values between velocityGraph and velocityGraph2.
 * @property {import('../../../core/math/curve-set.mjs').CurveSet} colorGraph Color over lifetime.
 * @property {import('../../../core/math/curve.mjs').Curve} rotationSpeedGraph Rotation speed over
 * lifetime.
 * @property {import('../../../core/math/curve.mjs').Curve} rotationSpeedGraph2 If not null,
 * particles pick random values between rotationSpeedGraph and rotationSpeedGraph2.
 * @property {import('../../../core/math/curve.mjs').Curve} radialSpeedGraph Radial speed over
 * lifetime, velocity vector points from emitter origin to particle pos.
 * @property {import('../../../core/math/curve.mjs').Curve} radialSpeedGraph2 If not null, particles
 * pick random values between radialSpeedGraph and radialSpeedGraph2.
 * @property {import('../../../core/math/curve.mjs').Curve} scaleGraph Scale over lifetime.
 * @property {import('../../../core/math/curve.mjs').Curve} scaleGraph2 If not null, particles pick
 * random values between scaleGraph and scaleGraph2.
 * @property {import('../../../core/math/curve.mjs').Curve} alphaGraph Alpha over lifetime.
 * @property {import('../../../core/math/curve.mjs').Curve} alphaGraph2 If not null, particles pick
...
class ParticleSystemComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').ParticleSystemComponentSystem} system - The ComponentSystem
     * that created this Component.
     * @param {import('../../entity.mjs').Entity} entity - The Entity this Component is attached to.
     */
