...
import { AnimClip } from '../../anim/evaluator/anim-clip.mjs';
import { AnimEvaluator } from '../../anim/evaluator/anim-evaluator.mjs';
import { AnimTrack } from '../../anim/evaluator/anim-track.mjs';
import { DefaultAnimBinder } from '../../anim/binder/default-anim-binder.mjs';
...
class AnimationComponent extends Component {
    /**
     * @type {Object<string, import('../../../scene/animation/animation.mjs').Animation>}
     * @private
     */
    _animations = {};
    ...
    /**
     * @type {import('../../../scene/model.mjs').Model|null}
     * @ignore
     */
    model = null;
     ...
     *
     * @param {import('./system.mjs').AnimationComponentSystem} system - The {@link ComponentSystem}
     ...
     * @returns {import('../../../scene/animation/animation.mjs').Animation} An Animation.
     */
    getAnimation(name) {
     ...
     *
     * @param {import('../../../scene/model.mjs').Model} model - The model to set.
     * @ignore
     */
    setModel(model) {
        if (model !== this.model) {
