...
import { AnimationComponent } from './component.mjs';
import { AnimationComponentData } from './data.mjs';
...
class AnimationComponentSystem extends ComponentSystem {
    ...
    /**
     * @param {import('../../entity.mjs').Entity} entity - The entity having its component removed.
