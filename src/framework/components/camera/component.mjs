...
import { ASPECT_AUTO, LAYERID_UI, LAYERID_DEPTH } from '../../../scene/constants.mjs';
import { Camera } from '../../../scene/camera.mjs';
import { ShaderPass } from '../../../scene/shader-pass.mjs';

import { Component } from '../component.mjs';

import { PostEffectQueue } from './post-effect-queue.mjs';
 ...
 * @param {import('../../../core/math/mat4.mjs').Mat4} transformMatrix - Output of the function.
...
class CameraComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').CameraComponentSystem} system - The ComponentSystem that
     * created this Component.
     * @param {import('../../entity.mjs').Entity} entity - The Entity that this Component is
     * attached to.
     */
     ...
     * [0.75, 0.75, 0.75, 1].
     *
     * @type {import('../../../core/math/color.mjs').Color}
     */
     ...
     *
     * @type {import('../../../core/shape/frustum.mjs').Frustum}
     */
    get frustum() {
     ...
     *
     * @type {import('../../../core/math/mat4.mjs').Mat4}
     */
     ...
     * Defaults to [0, 0, 1, 1].
     *
     * @type {import('../../../core/math/vec4.mjs').Vec4}
     */
    set rect(value) {
     ...
     *
     * @type {import('../../../platform/graphics/render-target.mjs').RenderTarget}
     */
    ...
    _enableDepthLayer(value) {
        ...
        if (hasDepthLayer) {
            ...
            /** @type {import('../../../scene/layer.mjs').Layer} */
     ...
     * point.
     * @param {import('../../../core/math/vec3.mjs').Vec3} [worldCoord] - 3D vector to receive world
     * coordinate result.
     * @example
     ...
     * });
     * @returns {import('../../../core/math/vec3.mjs').Vec3} The world space coordinate.
     */
     ...
     *
     * @param {import('../../../core/math/vec3.mjs').Vec3} worldCoord - The world space coordinate.
     * @param {import('../../../core/math/vec3.mjs').Vec3} [screenCoord] - 3D vector to receive
     * screen coordinate result.
     * @returns {import('../../../core/math/vec3.mjs').Vec3} The screen space coordinate.
     */
    ...
    /**
     * @param {import('../../../scene/composition/layer-composition.mjs').LayerComposition} oldComp - Old layer composition.
     * @param {import('../../../scene/composition/layer-composition.mjs').LayerComposition} newComp - New layer composition.
     * @private
     */
    ...
    /**
     * @param {import('../../../scene/layer.mjs').Layer} layer - The layer to add the camera to.
     * @private
     */
    onLayerAdded(layer) {
    ...
    /**
     * @param {import('../../../scene/layer.mjs').Layer} layer - The layer to remove the camera from.
     * @private
     */
     ...
     *
     * @param {import('../../../platform/graphics/render-target.mjs').RenderTarget} [rt] - Optional
     ...
     *
     * @param {import('../../../platform/graphics/render-target.mjs').RenderTarget} rt - Render
     ...
     * @param {import('../../xr/xr-manager.mjs').XrErrorCallback} [options.callback] - Optional
     ...
     *
     * @param {import('../../xr/xr-manager.mjs').XrErrorCallback} [callback] - Optional callback
