...
import { AnimTransition } from '../../anim/controller/anim-transition.mjs';
import { ANIM_LAYER_OVERWRITE } from '../../anim/controller/constants.mjs';
...
class AnimComponentLayer {
     ...
     * @param {import('./component.mjs').AnimComponent} component - The component that this layer is
     * a member of.
     ...
     * @returns {import('../../asset/asset.mjs').Asset} The asset associated with the given state.
     */
