...
import { FITTING_NONE } from './constants.mjs';
import { Component } from '../component.mjs';
import { LayoutCalculator } from './layout-calculator.mjs';
...
class LayoutGroupComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').LayoutGroupComponentSystem} system - The ComponentSystem that
