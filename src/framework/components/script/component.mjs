...
import { SortedLoopArray } from '../../../core/sorted-loop-array.mjs';

import { ScriptAttributes } from '../../script/script-attributes.mjs';
import {
...
class ScriptComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').ScriptComponentSystem} system - The ComponentSystem that
    ...
    constructor(system, entity) {
         ...
         *
         * @type {import('../../script/script-type.mjs').ScriptType[]}
         * @private
         */
        this._scripts = [];
     ...
     * @param {import('../../script/script-type.mjs').ScriptType} scriptInstance - The instance of
     ...
     *
     * @param {string|Class<import('../../script/script-type.mjs').ScriptType>} nameOrType - The
     ...
     * @param {string|Class<import('../../script/script-type.mjs').ScriptType>} nameOrType - The
     * name or type of {@link ScriptType}.
     * @returns {import('../../script/script-type.mjs').ScriptType|null} If script is attached, the
     ...
     * @returns {import('../../script/script-type.mjs').ScriptType|null} Returns an instance of a
