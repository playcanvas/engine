...
import { ORIENTATION_HORIZONTAL } from '../../../scene/constants.mjs';
 ...
 * height of the track.
 * @property {import('../../entity.mjs').Entity} handleEntity The entity to be used as the scrollbar
...
class ScrollbarComponent extends Component {
     ...
     *
     * @param {import('./system.mjs').ScrollbarComponentSystem} system - The ComponentSystem that
