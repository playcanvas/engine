...
import { XrHand } from './xr-hand.mjs';
...
class XrInputSource extends EventHandler {
    ...
    /**
     * @type {import('./xr-hit-test-source.mjs').XrHitTestSource[]}
     * @private
     */
    _hitTestSources = [];
     ...
     * @param {import('./xr-hit-test-source.mjs').XrHitTestSource} hitTestSource - Hit test source
     * that has been added.
     * @example
     ...
     * @param {import('./xr-hit-test.mjs').XrHitTestStartCallback} [options.callback] - Optional
