...
class XrJoint {
    ...
    /**
     * @type {import('./xr-hand.mjs').XrHand}
     * @private
     */
    _hand;

    /**
     * @type {import('./xr-finger.mjs').XrFinger}
     * @private
     */
    _finger;
     ...
     * @param {import('./xr-hand.mjs').XrHand} hand - Hand that joint relates to.
     * @param {import('./xr-finger.mjs').XrFinger|null} finger - Finger that joint is related to.
     ...
     *
     * @type {import('./xr-finger.mjs').XrFinger|null}
     */
    get finger() {
        return this._finger;
    }
