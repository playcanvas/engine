...
import { XrAnchor } from './xr-anchor.mjs';
...
class XrAnchors extends EventHandler {
     ...
     *
     * @param {import('../../core/math/vec3.mjs').Vec3} position - Position for an anchor.
     * @param {import('../../core/math/quat.mjs').Quat} [rotation] - Rotation for an anchor.
