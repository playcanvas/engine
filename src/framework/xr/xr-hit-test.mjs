...
import { XRSPACE_VIEWER, XRTYPE_AR } from './constants.mjs';
import { XrHitTestSource } from './xr-hit-test-source.mjs';
...
class XrHitTest extends EventHandler {
    /**
     * @type {import('./xr-manager.mjs').XrManager}
     * @private
     */
    manager;
     ...
     *
     * @param {import('./xr-manager.mjs').XrManager} manager - WebXR Manager.
     * @hideconstructor
     */
    constructor(manager) {
        super();
     ...
     * @param {import('../../core/math/vec3.mjs').Vec3} position - Position of hit test.
     * @param {import('../../core/math/quat.mjs').Quat} rotation - Rotation of hit test.
     * @param {import('./xr-input-source.mjs').XrInputSource|null} inputSource - If is transient hit
     ...
     *
     * @param {import('../../core/shape/ray.mjs').Ray} [options.offsetRay] - Optional ray by which
