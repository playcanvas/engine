...
import { XRHAND_LEFT } from './constants.mjs';
import { XrFinger } from './xr-finger.mjs';
import { XrJoint } from './xr-joint.mjs';
...
class XrHand extends EventHandler {
    ...
    /**
     * @type {import('./xr-input-source.mjs').XrInputSource}
     * @private
     */
    _inputSource;
     ...
     * Represents a hand with fingers and joints.
     *
     * @param {import('./xr-input-source.mjs').XrInputSource} inputSource - Input Source that hand
     * is related to.
     * @hideconstructor
     */
