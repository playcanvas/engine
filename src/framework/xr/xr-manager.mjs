...
import { XRTYPE_INLINE, XRTYPE_VR, XRTYPE_AR, XRDEPTHSENSINGUSAGE_CPU, XRDEPTHSENSINGFORMAT_L8A8 } from './constants.mjs';
import { XrDepthSensing } from './xr-depth-sensing.mjs';
import { XrDomOverlay } from './xr-dom-overlay.mjs';
import { XrHitTest } from './xr-hit-test.mjs';
import { XrImageTracking } from './xr-image-tracking.mjs';
import { XrInput } from './xr-input.mjs';
import { XrLightEstimation } from './xr-light-estimation.mjs';
import { XrPlaneDetection } from './xr-plane-detection.mjs';
import { XrAnchors } from './xr-anchors.mjs';
...
class XrManager extends EventHandler {
    ...
    /**
     * @type {import('../components/camera/component.mjs').CameraComponent}
     * @private
     */
    _camera = null;
     ...
     *
     * @param {import('../app-base.mjs').AppBase} app - The main application.
     * @hideconstructor
     */
    constructor(app) {
        super();
     ...
     *
     * @param {import('../components/camera/component.mjs').CameraComponent} camera - It will be
     ...
     *
     * @type {import('../entity.mjs').Entity|null}
     */
    get camera() {
