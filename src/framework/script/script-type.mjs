...
import { SCRIPT_INITIALIZE, SCRIPT_POST_INITIALIZE } from './constants.mjs';
import { ScriptAttributes } from './script-attributes.mjs';
...
class ScriptType extends EventHandler {
     ...
     * @param {import('../app-base.mjs').AppBase} args.app - The {@link AppBase} that is running the
     * script.
     * @param {import('../entity.mjs').Entity} args.entity - The {@link Entity} that the script is
     * attached to.
     */
    constructor(args) {
        super();
    ...
    /**
     * @param {{entity: import('../entity.mjs').Entity, app: import('../app-base.mjs').AppBase}} args -
     * The entity and app.
     * @private
     */
    initScriptType(args) {
