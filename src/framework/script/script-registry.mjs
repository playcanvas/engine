...
class ScriptRegistry extends EventHandler {
     ...
     *
     * @param {import('../app-base.mjs').AppBase} app - Application to attach registry to.
     */
    constructor(app) {
        super();
     ...
     *
     * @param {Class<import('./script-type.mjs').ScriptType>} script - Script Type that is created
     ...
     *
     * @param {string|Class<import('./script-type.mjs').ScriptType>} nameOrType - The name or type
     * of {@link ScriptType}.
     ...
     * @returns {Class<import('./script-type.mjs').ScriptType>} The Script Type if it exists in the
     ...
     *
     * @returns {Array<Class<import('./script-type.mjs').ScriptType>>} list of all {@link ScriptType}s
     * in registry.
     * @example
