...
import { Tags } from '../../core/tags.mjs';

import { EventHandler } from '../../core/event-handler.mjs';

import { findAvailableLocale } from '../i18n/utils.mjs';

import { ABSOLUTE_URL } from './constants.mjs';
import { AssetFile } from './asset-file.mjs';
...
class Asset extends EventHandler {
    ...
    constructor(name, type, file, data, options) {
         ...
         *
         * @type {import('./asset-registry.mjs').AssetRegistry|null}
         */
        this.registry = null;
     ...
     * @param {import('../handlers/loader.mjs').ResourceLoaderCallback} callback - The callback
