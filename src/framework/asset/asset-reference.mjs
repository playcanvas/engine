...
class AssetReference {
     ...
     * @param {import('./asset.mjs').Asset|object} parent - The parent object that contains the
     * asset reference, passed into callbacks to enable updating. Currently an asset, but could be
     * component or other.
     * @param {import('./asset-registry.mjs').AssetRegistry} registry - The asset registry that
     * stores all assets.
