 ...
 * property of a component, and calls back when that asset is added to the registry, loads,
 * unloads or is removed. Point it at an asset by setting {@link AssetReference#id} or
 * {@link AssetReference#url}. The asset does not need to exist yet: the `add` callback fires when
 * an asset with that id or URL is later registered.
 *
 * @example
