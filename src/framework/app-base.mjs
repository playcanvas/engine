// #if _DEBUG
import { version, revision } from '../core/core.mjs';
// #endif
import { platform } from '../core/platform.mjs';
import { now } from '../core/time.mjs';
import { path } from '../core/path.mjs';
import { TRACEID_RENDER_FRAME, TRACEID_RENDER_FRAME_TIME } from '../core/constants.mjs';
...
import { http } from '../platform/net/http.mjs';

import {
    LAYERID_DEPTH, LAYERID_IMMEDIATE, LAYERID_SKYBOX, LAYERID_UI, LAYERID_WORLD,
    SORTMODE_NONE, SORTMODE_MANUAL, SPECULAR_BLINN
} from '../scene/constants.mjs';
import { setProgramLibrary } from '../scene/shader-lib/get-program-library.mjs';
...
import { FrameGraph } from '../scene/frame-graph.mjs';
import { AreaLightLuts } from '../scene/area-light-luts.mjs';
...
import { LightsBuffer } from '../scene/lighting/lights-buffer.mjs';
import { StandardMaterial } from '../scene/materials/standard-material.mjs';
import { setDefaultMaterial } from '../scene/materials/default-material.mjs';

import { Asset } from './asset/asset.mjs';
import { AssetRegistry } from './asset/asset-registry.mjs';
import { BundleRegistry } from './bundle/bundle-registry.mjs';
import { ComponentSystemRegistry } from './components/registry.mjs';
import { SceneGrab } from '../scene/graphics/scene-grab.mjs';
import { BundleHandler } from './handlers/bundle.mjs';
import { ResourceLoader } from './handlers/loader.mjs';
import { I18n } from './i18n/i18n.mjs';
import { ScriptRegistry } from './script/script-registry.mjs';
import { Entity } from './entity.mjs';
import { SceneRegistry } from './scene-registry.mjs';
import { script } from './script.mjs';
import { ApplicationStats } from './stats.mjs';
...
class AppBase extends EventHandler {
     ...
     * Initialize the app.
     *
     * @param {import('./app-options.mjs').AppOptions} appOptions - Options specifying the init
     ...
     *
     * @param {import('../scene/mesh-instance.mjs').MeshInstance} meshInstance - The mesh instance
     * to draw.
     ...
     *
     * @param {import('../scene/mesh.mjs').Mesh} mesh - The mesh to draw.
     ...
     * the range [0, 2].
     * @param {import('../platform/graphics/texture.mjs').Texture} texture - The texture to render.
