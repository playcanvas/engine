...
class PlyHandler {
    ...
    /**
     * Create a new PlyHandler instance.
     *
    ...
    constructor(app) {
        ...
        this.parser = new PlyParser(device, assets, 3);
    }

    load(url, callback, asset) {
        console.log("PlyHandler.load");
    }

    open(url, data, asset) {
        console.log("PlyHandler.open");
        if (!url)
            return undefined;
    }

    patch(asset, assets) {
        console.log("PlyHandler.patch");
    }
}
