...
import { GlbContainerParser } from '../parsers/glb-container-parser.mjs';

/** @typedef {import('./handler.mjs').ResourceHandler} ResourceHandler */

/**
 * @interface
 * @name ContainerResource
 * @description Container for a list of animations, textures, materials, renders and a model.
 * @property {import('../asset/asset.mjs').Asset[]} renders An array of the Render assets.
 * @property {import('../asset/asset.mjs').Asset[]} materials An array of {@link Material} and/or {@link StandardMaterial} assets.
 * @property {import('../asset/asset.mjs').Asset[]} textures An array of the {@link Texture} assets.
 * @property {import('../asset/asset.mjs').Asset[]} animations An array of the {@link Animation} assets.
 * @category Graphics
 */
class ContainerResource {
     ...
     * {@link ModelComponent}.
     * @returns {import('../entity.mjs').Entity} A single entity with a model component. Model
     ...
     * @returns {import('../entity.mjs').Entity} A hierarchy of entities with render components on
     ...
     *
     * @param {import('../entity.mjs').Entity} entity - The entity root to which material variants
     * will be applied.
...
class ContainerHandler {
     ...
     *
     * @param {import('../app-base.mjs').AppBase} app - The running {@link AppBase}.
     * @hideconstructor
     */
    constructor(app) {
     ...
     * @param {import('./handler.mjs').ResourceHandlerCallback} callback - The callback used when
     * the resource is loaded or an error occurs.
     * @param {import('../asset/asset.mjs').Asset} [asset] - Optional asset that is passed by
     * ResourceLoader.
     */
    ...
    /**
     * @param {import('../asset/asset.mjs').Asset} asset - The asset to patch.
     * @param {import('../asset/asset-registry.mjs').AssetRegistry} assets - The asset registry.
     */
    patch(asset, assets) {
