...
class ResourceLoader {
     ...
     *
     * @param {import('./handler.mjs').ResourceHandler} handler - An instance of a resource handler
     ...
     * @returns {import('./handler.mjs').ResourceHandler|undefined} The registered handler, or
     ...
     * @param {import('../asset/asset.mjs').Asset} [asset] - Optional asset that is passed into
     * handler.
     * @example
