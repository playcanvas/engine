 ...
 * A handler may also implement {@link ResourceHandler#patch} to resolve references to other assets
 * once the resource exists. Rather than overriding those methods, a handler can register one
 * {@link ResourceParser} per file format with {@link ResourceHandler#addParser} and let the base
 * class pick the parser that claims the file.
 *
 * @example
