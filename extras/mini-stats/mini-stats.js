...
/**
 * MiniStats is a small HTML overlay that displays realtime performance metrics. By default, it
 * shows CPU and GPU utilization, frame timings and draw call count. It can also be configured to
 * display additional graphs based on data collected into {@link AppBase#stats}.
 */
class MiniStats {
    /**
