...
CubemapRenderer.attributes.add('layerBaseName', {
    title: 'Layer Base Name',
    description: 'Base name for 6 layers created. For example when "CubeLayer" is specified, layers "CubeLayer0", CubeLayer1" .. "CubeLayer5" need to exist.',
    type: 'string',
    default: "CubeLayer"
});
