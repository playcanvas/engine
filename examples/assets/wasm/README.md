...
The shipped build is kripken/ammo.js PR #449 (commit 6a1dfd3), built with emsdk 3.1.35 and
CLOSURE=1. It starts with a 16MB heap that grows on demand instead of a fixed 64MB heap, so it
