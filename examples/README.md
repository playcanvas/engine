...
### `controls` function
This function allows you to define a set of PCUI based UI which can be used to display stats from your example or provide example users a way of controlling the example.
```tsx
