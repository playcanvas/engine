...
import modelsAnisotropydisctestGlbUrl from 'examples/assets/models/AnisotropyDiscTest.glb?url';
...
const assets = {
    ...
    model: new pc.Asset('model', 'container', { url: modelsAnisotropydisctestGlbUrl })
};
