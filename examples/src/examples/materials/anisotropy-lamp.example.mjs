...
import modelsAnisotropybarnlampGlbUrl from 'examples/assets/models/AnisotropyBarnLamp.glb?url';
...
const assets = {
    ...
    model: new pc.Asset('model', 'container', { url: modelsAnisotropybarnlampGlbUrl })
};
