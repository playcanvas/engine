...
import modelsNormaltangenttestGlbUrl from 'examples/assets/models/NormalTangentTest.glb?url';
...
const assets = {
    ...
    model: new pc.Asset('model', 'container', { url: modelsNormaltangenttestGlbUrl })
};
