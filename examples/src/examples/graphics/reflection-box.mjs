        ...
        return React.createElement(React.Fragment, null,
            React.createElement(Panel, { headerText: 'Settings' },
                ...
                React.createElement(LabelGroup, { text: 'Gloss' },
                    React.createElement(SliderInput, { binding: new BindingTwoWay(), link: { observer: data, path: 'settings.gloss' }, min: 0, max: 1, precision: 2 })),
                React.createElement(LabelGroup, { text: 'Metalness' },
                    React.createElement(SliderInput, { binding: new BindingTwoWay(), link: { observer: data, path: 'settings.metalness' }, min: 0, max: 1, precision: 2 })),
                React.createElement(LabelGroup, { text: 'Reflectivity' },
                    React.createElement(SliderInput, { binding: new BindingTwoWay(), link: { observer: data, path: 'settings.reflectivity' }, min: 0, max: 1, precision: 2 })),
