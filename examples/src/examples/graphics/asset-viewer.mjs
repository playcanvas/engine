...
export class AssetViewerExample {
    ...
    controls(data) {
        return React.createElement(React.Fragment, null,
            React.createElement(Panel, { headerText: 'Asset' },
                React.createElement(Button, { text: 'Previous', onClick: () => data.emit('previous') }),
                React.createElement(Button, { text: 'Next', onClick: () => data.emit('next') })));
    }
