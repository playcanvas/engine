...
import modelsScifiPlatformGlbUrl from 'examples/assets/models/scifi-platform.glb?url';
...
const assets = {
    ...
    platform: new pc.Asset('statue', 'container', { url: modelsScifiPlatformGlbUrl }),
