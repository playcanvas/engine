...
import modelsPrimitivemodenormalstestGlbUrl from 'examples/assets/models/PrimitiveModeNormalsTest.glb?url';
...
const assets = {
    ...
    model: new pc.Asset('model', 'container', { url: modelsPrimitivemodenormalstestGlbUrl })
};
