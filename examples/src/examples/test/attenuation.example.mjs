...
import modelsAttenuationtestGlbUrl from 'examples/assets/models/AttenuationTest.glb?url';
...
const assets = {
    ...
    model: new pc.Asset('model', 'container', { url: modelsAttenuationtestGlbUrl })
};
