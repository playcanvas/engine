...
Out coding standards are based on the [Google JavaScript Coding Standards](https://google.github.io/styleguide/javascriptguide.xml) which is ES5 (ECMA2009), with more specifics bellow. Also we have a whitelist of modern JavaScript features (ES6+), explicitly listed below.
