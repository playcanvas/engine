...
describe('Color', () => {
    ...
    describe('#fromArray', () => {
        ...
        it('sets a color from an array with an offset', () => {
            const c = new Color();
    ...
    describe('#toArray', () => {
        ...
        it('returns an array of 3 values', () => {
            expect(Color.RED.toArray(undefined, undefined, false)).to.eql([1, 0, 0]);
        });

        it('returns an array of 3 values with an offset and target array', () => {
