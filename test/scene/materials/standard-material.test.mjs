...
describe('StandardMaterial', function () {
    ...
    function checkDefaultMaterial(material) {
        ...
        expect(material.anisotropyMapChannel).to.equal('b');
        ...
        expect(material.anisotropyRotationMap).to.be.null;
        expect(material.anisotropyRotationMapChannel).to.equal('rg');
        expect(material.anisotropyRotationMapOffset).to.be.an.instanceof(Vec2);
        expect(material.anisotropyRotationMapOffset.x).to.equal(0);
        expect(material.anisotropyRotationMapOffset.y).to.equal(0);
        expect(material.anisotropyRotationMapRotation).to.equal(0);
        expect(material.anisotropyRotationMapTiling).to.be.an.instanceof(Vec2);
