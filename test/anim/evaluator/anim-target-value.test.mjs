import { AnimTargetValue } from '../../../src/anim/evaluator/anim-target-value.js';
import { ANIM_LAYER_ADDITIVE, ANIM_LAYER_OVERWRITE } from '../../../src/anim/controller/constants.js';
