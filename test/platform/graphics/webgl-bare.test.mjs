...
describe('WebglGraphicsDevice bare feature level', function () {
    ...
    /**
     * @param {string} [featureLevel] - The requested feature level.
     * @param {Record<string, number>} [params] - The capabilities the context reports.
     * @returns {object} The device, destroyed after the test.
     */
    const device = (featureLevel, params) => {
        const created = initDevice(featureLevel, params);
