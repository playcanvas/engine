...
describe('WebgpuBindGroupFormat#createDescriptor', function () {
    ...
    it('includes the multisampled flag in the pipeline-cache key', function () {
        const sampled = new BindTextureFormat('color', SHADERSTAGE_FRAGMENT, TEXTUREDIMENSION_2D, SAMPLETYPE_FLOAT, false);
        ...
        expect(sampledKey).to.contain('-false');
        expect(multisampledKey).to.contain('-true');
    });
});
