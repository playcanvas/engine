...
const STANDARD_MAT_PROPS = [
    ...
    ['anisotropyRotationMap', 'Texture|null'],
    ['anisotropyRotationMapChannel', 'string'],
    ['anisotropyRotationMapOffset', 'Vec2'],
    ['anisotropyRotationMapRotation', 'number'],
    ['anisotropyRotationMapTiling', 'Vec2'],
    ['anisotropyRotationMapUv', 'number'],
    ['aoIntensity', 'number'],
    ['aoMap', 'Texture|null'],
    ['aoMapChannel', 'string'],
    ['aoMapOffset', 'Vec2'],
